...
com_alter_common(wordlist *wl, int do_model)
{
    ...
    if (!names) {
     //Pongo esto para intentar solventar el caso de alter@vin_sin[sin] = (10 12 3000)
     char *xsbuf;
     int type = IF_REALVEC,i=0;
      ...
      // fprintf(cp_err, "Cadena    convertida  %s \n",xsbuf);
      ...
      dv->v_name = "real vector";
       ...
       //me he quedado por aqui, para modificar la inclusi�n en el circuito.
       //habr�a que revisar que el dv es correcto para su insercion.
