         ...
         */
{
    ...
    ,Qcth_Vrth=0.0
    ,Tf, Tf_Vbei, Tf_Vbci, Tf_Vrth=0.0
    ,SCALE;
...
//NQS
    double Ixf1, Ixf2, Qxf1, Qxf2, Qxf1_Vxf1, Qxf2_Vxf2;
    double Ixf1_Vxf1, Ixf1_Vxf2, Ixf1_ditf, Ixf1_dTf, Ixf1_Vbei, Ixf1_Vbci, Ixf1_Vrth;
    double Ixf2_Vxf1, Ixf2_Vbei, Ixf2_Vbci, Ixf2_Vrth;
    double Ixf2_Vxf2, Ixf2_dTf;
    double Itxf;
    double Itxf_Vxf2, Itxf_Vbci, Itxf_Vbei, Itxf_Vrth;
    double Vxf1, Vxf2;
        ...
        for (here = VBICinstances(model); here != NULL ;
            ...
            if (!here->VBIC_selfheat) {
                iret = vbic_4T_it_cf_fj(p
                    ...
                    ,&Iccp_Vbcp, &Irs, &Irs_Vrs, &Qbcp, &Qbcp_Vbcp
                    ,&Tf, &Tf_Vbei, &Tf_Vbci
                    ,&SCALE);
            } else if (here->VBIC_selfheat) {
...
//                here->VBICiciei_Vrth = Iciei_Vrth;
...
int vbic_4T_it_cf_fj(double *p
    ...
    ,double *tff, double *tff_Vbei, double *tff_Vbci
    ,double *SCALE)
{
...
double  rIf,rIf_Ifi,rIf_Vbei,mIf,mIf_rIf,mIf_Vbei;
double  tff_q1,tff_xvar2,tff_mIf,Qbe_qdbe,Qbe_tff;
double  Qbe_Ifi,Qbe_qb,Qbex_qdbex,Qbc_qdbc,Qbc_Iri,Qbc_Kbci,Qbcx_Kbcx;
double  Qbep_qdbep,Qbep_Ifp,Qbcp_qdbcp;
//double  tff, tff_Vbei, tff_Vbci;
