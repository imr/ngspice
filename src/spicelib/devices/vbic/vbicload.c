...
*/
                rhs_current = Icxf - Icxf_Vcxf*Vcxf;
                *(ckt->CKTrhs + here->VBICxf1Node) += -rhs_current;
                *(here->VBICxf1Xf1Ptr) +=  Icxf_Vcxf;
/*
...
int vbic_4T_et_xf_fj(double *p
    ,double *Vrth,double *Vbei,double *Vbex,double *Vbci,double *Vbep,double *Vbcp
    ,double *Vrxf,double *Vrcx,double *Vbcx,double *Vrci,double *Vrbx,double *Vrbi,double *Vre
    ,double *Vrbp,double *Vrs,double *Vbe,double *Vbc,double *Vcei,double *Vcep,double *Vcxf
    ,double *Ibe,double *Ibe_Vrth,double *Ibe_Vbei,double *Ibex,double *Ibex_Vrth,double *Ibex_Vbex,double *Itxf
    ,double *Itxf_Vrxf,double *Itzr,double *Itzr_Vrth,double *Itzr_Vbci,double *Itzr_Vbei,double *Ibc,double *Ibc_Vrth
    ,double *Ibc_Vbci,double *Ibc_Vrxf,double *Ibc_Vbei,double *Ibep,double *Ibep_Vrth,double *Ibep_Vbep,double *Ircx
    ,double *Ircx_Vrcx,double *Ircx_Vrth,double *Irci,double *Irci_Vrci,double *Irci_Vrth,double *Irci_Vbci,double *Irci_Vbcx
    ,double *Irbx,double *Irbx_Vrbx,double *Irbx_Vrth,double *Irbi,double *Irbi_Vrbi,double *Irbi_Vrth,double *Irbi_Vbei
    ,double *Irbi_Vbci,double *Ire,double *Ire_Vre,double *Ire_Vrth,double *Irbp,double *Irbp_Vrbp,double *Irbp_Vrth
    ,double *Irbp_Vbep,double *Irbp_Vbci,double *Qbe,double *Qbe_Vrth,double *Qbe_Vbei,double *Qbe_Vbci,double *Qbex
    ,double *Qbex_Vrth,double *Qbex_Vbex,double *Qbc,double *Qbc_Vrth,double *Qbc_Vbci,double *Qbcx,double *Qbcx_Vrth
    ,double *Qbcx_Vbcx,double *Qbep,double *Qbep_Vrth,double *Qbep_Vbep,double *Qbep_Vbci,double *Qbeo,double *Qbeo_Vbe
    ,double *Qbco,double *Qbco_Vbc,double *Ibcp,double *Ibcp_Vrth,double *Ibcp_Vbcp,double *Iccp,double *Iccp_Vrth
    ,double *Iccp_Vbep,double *Iccp_Vbci,double *Iccp_Vbcp,double *Irs,double *Irs_Vrs,double *Irs_Vrth,double *Qbcp
    ,double *Qbcp_Vrth,double *Qbcp_Vbcp,double *Irth,double *Irth_Vrth,double *Ith,double *Ith_Vrth,double *Ith_Vbei
    ,double *Ith_Vbci,double *Ith_Vrxf,double *Ith_Vcei,double *Ith_Vbex,double *Ith_Vbep,double *Ith_Vrs,double *Ith_Vbcp
    ,double *Ith_Vcep,double *Ith_Vrcx,double *Ith_Vrci,double *Ith_Vbcx,double *Ith_Vrbx,double *Ith_Vrbi,double *Ith_Vre
    ,double *Ith_Vrbp,double *Qcth,double *Qcth_Vrth,double *Ixzf,double *Ixzf_Vrth,double *Ixzf_Vbei,double *Ixzf_Vbci
    ,double *Ixxf,double *Ixxf_Vrxf,double *Qcxf,double *Qcxf_Vcxf,double *Flxf,double *Flxf_Vrxf,double *SCALE)
{
double  Tini,Tdev,Tdev_Vrth,Vtv,Vtv_Tdev,Vtv_Vrth,rT;
double  rT_Tdev,rT_Vrth,dT,dT_Tdev,dT_Vrth,xvar1,xvar1_rT;
double  xvar1_Vrth,IKFatT,IKFatT_xvar1,IKFatT_Vrth,RCXatT,RCXatT_xvar1,RCXatT_Vrth;
