{
  ...
  Vec8d dVbseffCV_dVb;
  Vec8d Arg1;
  float One_Third_CoxWL;
  float Two_Third_CoxWL;
  Vec8d Alphaz;
  float CoxWL;
  Vec8d T0;
  Vec8d dT0_dVg;
  ...
  Check = vec8_SIMDLOADDATA(6, data) > ((float) 0.5);
  SIMDIFYCMD(start);
  vbd = vbs - vds;
  vgd = vgs - vds;
  vgb = vgs - vbs;
  ...
  if (1)
  {
    Vec8m condmask0 = SourceSatCurrent <= ((float) 0.0);
    Vec8m condmask_true0 = condmask0;
    Vec8m condmask_false0 = ~condmask0;
    {
      {
    ...
    }
    {
      ...
      {
        evbs = vec8_blend(evbs, vec8_exp(vbs / ((float) Nvtm)), condmask_false0);
        {
          Vec8d val = ((SourceSatCurrent * evbs) / ((float) Nvtm)) + ((float) ckt->CKTgmin);
        ...
        {
          Vec8d val = (SourceSatCurrent * (evbs - ((float) 1.0))) + (((float) ckt->CKTgmin) * vbs);
          if (condmask_false0[0])
            heres[0]->BSIM3v32cbs = val[0];
      ...
      else
      {
        if (1)
        {
          ...
          {
            evbs = vec8_blend(evbs, vec8_exp(vbs / ((float) Nvtm)), condmask_true1);
            {
              Vec8d val = ((SourceSatCurrent * evbs) / ((float) Nvtm)) + ((float) ckt->CKTgmin);
              if (condmask_true1[0])
                heres[0]->BSIM3v32gbs = val[0];
          ...
          }
          {
            switch (model->BSIM3v32intVersion)
            {
              ...
              case BSIM3v32V322:
                T0 = vec8_blend(T0, ((Vec8d ){heres[0]->BSIM3v32IsEvjsm, heres[1]->BSIM3v32IsEvjsm, heres[2]->BSIM3v32IsEvjsm, heres[3]->BSIM3v32IsEvjsm, heres[4]->BSIM3v32IsEvjsm, heres[5]->BSIM3v32IsEvjsm, heres[6]->BSIM3v32IsEvjsm, heres[7]->BSIM3v32IsEvjsm}) / ((float) Nvtm), condmask_false1);
              {
                Vec8d val = T0 + ((float) ckt->CKTgmin);
              ...
              default:
                T0 = vec8_blend(T0, (SourceSatCurrent + ((float) model->BSIM3v32ijth)) / ((float) Nvtm), condmask_false1);
              {
                Vec8d val = T0 + ((float) ckt->CKTgmin);
                if (condmask_false1[0])
                  heres[0]->BSIM3v32gbs = val[0];
              ...
              {
                Vec8d val = (((float) model->BSIM3v32ijth) + (((float) ckt->CKTgmin) * vbs)) + (T0 * (vbs - ((Vec8d ){heres[0]->BSIM3v32vjsm, heres[1]->BSIM3v32vjsm, heres[2]->BSIM3v32vjsm, heres[3]->BSIM3v32vjsm, heres[4]->BSIM3v32vjsm, heres[5]->BSIM3v32vjsm, heres[6]->BSIM3v32vjsm, heres[7]->BSIM3v32vjsm})));
                if (condmask_false1[0])
                  heres[0]->BSIM3v32cbs = val[0];
  ...
  if (1)
  {
    Vec8m condmask0 = DrainSatCurrent <= ((float) 0.0);
    Vec8m condmask_true0 = condmask0;
    Vec8m condmask_false0 = ~condmask0;
    {
      {
    ...
    }
    {
      if (model->BSIM3v32ijth == 0.0)
      {
        evbd = vec8_blend(evbd, vec8_exp(vbd / ((float) Nvtm)), condmask_false0);
        {
          Vec8d val = ((DrainSatCurrent * evbd) / ((float) Nvtm)) + ((float) ckt->CKTgmin);
          if (condmask_false0[0])
        ...
        {
          Vec8d val = (DrainSatCurrent * (evbd - ((float) 1.0))) + (((float) ckt->CKTgmin) * vbd);
          if (condmask_false0[0])
            heres[0]->BSIM3v32cbd = val[0];
      ...
      else
      {
        if (1)
        {
          ...
          Vec8m condmask_false1 = condmask_false0 & (~condmask1);
          {
            evbd = vec8_blend(evbd, vec8_exp(vbd / ((float) Nvtm)), condmask_true1);
            {
              Vec8d val = ((DrainSatCurrent * evbd) / ((float) Nvtm)) + ((float) ckt->CKTgmin);
              if (condmask_true1[0])
                heres[0]->BSIM3v32gbd = val[0];
          ...
          }
          {
            switch (model->BSIM3v32intVersion)
            {
              ...
              case BSIM3v32V322:
                T0 = vec8_blend(T0, ((Vec8d ){heres[0]->BSIM3v32IsEvjdm, heres[1]->BSIM3v32IsEvjdm, heres[2]->BSIM3v32IsEvjdm, heres[3]->BSIM3v32IsEvjdm, heres[4]->BSIM3v32IsEvjdm, heres[5]->BSIM3v32IsEvjdm, heres[6]->BSIM3v32IsEvjdm, heres[7]->BSIM3v32IsEvjdm}) / ((float) Nvtm), condmask_false1);
              {
                Vec8d val = T0 + ((float) ckt->CKTgmin);
                if (condmask_false1[0])
                  heres[0]->BSIM3v32gbd = val[0];
              ...
              default:
                T0 = vec8_blend(T0, (DrainSatCurrent + ((float) model->BSIM3v32ijth)) / ((float) Nvtm), condmask_false1);
              {
                Vec8d val = T0 + ((float) ckt->CKTgmin);
                if (condmask_false1[0])
                  heres[0]->BSIM3v32gbd = val[0];
              ...
              {
                Vec8d val = (((float) model->BSIM3v32ijth) + (((float) ckt->CKTgmin) * vbd)) + (T0 * (vbd - ((Vec8d ){heres[0]->BSIM3v32vjdm, heres[1]->BSIM3v32vjdm, heres[2]->BSIM3v32vjdm, heres[3]->BSIM3v32vjdm, heres[4]->BSIM3v32vjdm, heres[5]->BSIM3v32vjdm, heres[6]->BSIM3v32vjdm, heres[7]->BSIM3v32vjdm})));
                if (condmask_false1[0])
                  heres[0]->BSIM3v32cbd = val[0];
  ...
  T0 = (Vbs - ((float) pParam->BSIM3v32vbsc)) - ((float) 0.001);
  T1 = vec8_sqrt((T0 * T0) - ((float) (0.004 * pParam->BSIM3v32vbsc)));
  Vbseff = ((float) pParam->BSIM3v32vbsc) + (((float) 0.5) * (T0 + T1));
  dVbseff_dVb = ((float) 0.5) * (((float) 1.0) + (T0 / T1));
  if (1)
  {
  ...
  if (1)
  {
    Vec8m condmask0 = Vbseff > ((float) 0.0);
    Vec8m condmask_true0 = condmask0;
    Vec8m condmask_false0 = ~condmask0;
    {
      T0 = vec8_blend(T0, ((float) pParam->BSIM3v32phi) / (((float) pParam->BSIM3v32phi) + Vbseff), condmask_true0);
      Phis = vec8_blend(Phis, ((float) pParam->BSIM3v32phi) * T0, condmask_true0);
      dPhis_dVb = vec8_blend(dPhis_dVb, (-T0) * T0, condmask_true0);
      sqrtPhis = vec8_blend(sqrtPhis, ((float) pParam->BSIM3v32phis3) / (((float) pParam->BSIM3v32phi) + (((float) 0.5) * Vbseff)), condmask_true0);
      dsqrtPhis_dVb = vec8_blend(dsqrtPhis_dVb, ((((float) (-0.5)) * sqrtPhis) * sqrtPhis) / ((float) pParam->BSIM3v32phis3), condmask_true0);
    }
    {
      Phis = vec8_blend(Phis, ((float) pParam->BSIM3v32phi) - Vbseff, condmask_false0);
      ...
      dsqrtPhis_dVb = vec8_blend(dsqrtPhis_dVb, ((float) (-0.5)) / sqrtPhis, condmask_false0);
    }
  }

  Xdep = (((float) pParam->BSIM3v32Xdep0) * sqrtPhis) / ((float) pParam->BSIM3v32sqrtPhi);
  dXdep_dVb = ((float) (pParam->BSIM3v32Xdep0 / pParam->BSIM3v32sqrtPhi)) * dsqrtPhis_dVb;
  Leff = pParam->BSIM3v32leff;
  Vtm = model->BSIM3v32vtm;
  T3 = vec8_sqrt(Xdep);
  V0 = pParam->BSIM3v32vbi - pParam->BSIM3v32phi;
  T0 = ((float) pParam->BSIM3v32dvt2) * Vbseff;
  T2 = vec8_SIMDTOVECTOR(pParam->BSIM3v32dvt2);
  if (1)
  {
    Vec8m condmask0 = T0 >= ((float) (-0.5));
    Vec8m condmask_true0 = condmask0;
    Vec8m condmask_false0 = ~condmask0;
    {
      T1 = vec8_blend(T1, ((float) 1.0) + T0, condmask_true0);
    }
    {
      T4 = vec8_blend(T4, ((float) 1.0) / (((float) 3.0) + (((float) 8.0) * T0)), condmask_false0);
      T1 = vec8_blend(T1, (((float) 1.0) + (((float) 3.0) * T0)) * T4, condmask_false0);
      T2 = vec8_blend(T2, (T2 * T4) * T4, condmask_false0);
    }
  }

  lt1 = (((float) model->BSIM3v32factor1) * T3) * T1;
  dlt1_dVb = ((float) model->BSIM3v32factor1) * ((((((float) 0.5) / T3) * T1) * dXdep_dVb) + (T3 * T2));
  T0 = ((float) pParam->BSIM3v32dvt2w) * Vbseff;
  if (1)
  {
    Vec8m condmask0 = T0 >= ((float) (-0.5));
    Vec8m condmask_true0 = condmask0;
    ...
    }
    {
      T4 = vec8_blend(T4, ((float) 1.0) / (((float) 3.0) + (((float) 8.0) * T0)), condmask_false0);
      T1 = vec8_blend(T1, (((float) 1.0) + (((float) 3.0) * T0)) * T4, condmask_false0);
      T2 = vec8_blend(T2, (((float) pParam->BSIM3v32dvt2w) * T4) * T4, condmask_false0);
    }
  }

  ltw = (((float) model->BSIM3v32factor1) * T3) * T1;
  dltw_dVb = ((float) model->BSIM3v32factor1) * ((((((float) 0.5) / T3) * T1) * dXdep_dVb) + (T3 * T2));
  T0 = ((float) (((-0.5) * pParam->BSIM3v32dvt1) * Leff)) / lt1;
  if (1)
  {
    Vec8m condmask0 = T0 > ((float) (-EXP_THRESHOLD));
    Vec8m condmask_true0 = condmask0;
    Vec8m condmask_false0 = ~condmask0;
    {
      T1 = vec8_blend(T1, vec8_exp(T0), condmask_true0);
      Theta0 = vec8_blend(Theta0, T1 * (((float) 1.0) + (((float) 2.0) * T1)), condmask_true0);
      dT1_dVb = vec8_blend(dT1_dVb, (((-T0) / lt1) * T1) * dlt1_dVb, condmask_true0);
      dTheta0_dVb = vec8_blend(dTheta0_dVb, (((float) 1.0) + (((float) 4.0) * T1)) * dT1_dVb, condmask_true0);
    }
    {
      T1 = vec8_blend(T1, vec8_SIMDTOVECTOR(MIN_EXP), condmask_false0);
      Theta0 = vec8_blend(Theta0, T1 * (((float) 1.0) + (((float) 2.0) * T1)), condmask_false0);
      dTheta0_dVb = vec8_blend(dTheta0_dVb, vec8_SIMDTOVECTOR(0.0), condmask_false0);
    }
  }

  Delt_vth = (((float) pParam->BSIM3v32dvt0) * Theta0) * ((float) V0);
  dDelt_vth_dVb = (((float) pParam->BSIM3v32dvt0) * dTheta0_dVb) * ((float) V0);
  T0 = ((float) ((((-0.5) * pParam->BSIM3v32dvt1w) * pParam->BSIM3v32weff) * Leff)) / ltw;
  if (1)
  {
    Vec8m condmask0 = T0 > ((float) (-EXP_THRESHOLD));
    Vec8m condmask_true0 = condmask0;
    ...
    {
      T1 = vec8_blend(T1, vec8_exp(T0), condmask_true0);
      T2 = vec8_blend(T2, T1 * (((float) 1.0) + (((float) 2.0) * T1)), condmask_true0);
      dT1_dVb = vec8_blend(dT1_dVb, (((-T0) / ltw) * T1) * dltw_dVb, condmask_true0);
      dT2_dVb = vec8_blend(dT2_dVb, (((float) 1.0) + (((float) 4.0) * T1)) * dT1_dVb, condmask_true0);
    }
    {
      T1 = vec8_blend(T1, vec8_SIMDTOVECTOR(MIN_EXP), condmask_false0);
      T2 = vec8_blend(T2, T1 * (((float) 1.0) + (((float) 2.0) * T1)), condmask_false0);
      dT2_dVb = vec8_blend(dT2_dVb, vec8_SIMDTOVECTOR(0.0), condmask_false0);
    }
  }

  T0 = ((float) pParam->BSIM3v32dvt0w) * T2;
  T2 = T0 * ((float) V0);
  dT2_dVb = (((float) pParam->BSIM3v32dvt0w) * dT2_dVb) * ((float) V0);
  TempRatio = (ckt->CKTtemp / model->BSIM3v32tnom) - 1.0;
  T0 = vec8_SIMDTOVECTOR(sqrt(1.0 + (pParam->BSIM3v32nlx / Leff)));
  T1 = ((((float) pParam->BSIM3v32k1ox) * (T0 - ((float) 1.0))) * ((float) pParam->BSIM3v32sqrtPhi)) + ((((float) (pParam->BSIM3v32kt1 + (pParam->BSIM3v32kt1l / Leff))) + (((float) pParam->BSIM3v32kt2) * Vbseff)) * ((float) TempRatio));
  tmp2 = vec8_SIMDTOVECTOR((model->BSIM3v32tox * pParam->BSIM3v32phi) / (pParam->BSIM3v32weff + pParam->BSIM3v32w0));
  T3 = ((float) pParam->BSIM3v32eta0) + (((float) pParam->BSIM3v32etab) * Vbseff);
  if (1)
  {
    Vec8m condmask0 = T3 < ((float) 1.0e-4);
    Vec8m condmask_true0 = condmask0;
    Vec8m condmask_false0 = ~condmask0;
    {
      T9 = vec8_blend(T9, ((float) 1.0) / (((float) 3.0) - (((float) 2.0e4) * T3)), condmask_true0);
      T3 = vec8_blend(T3, (((float) 2.0e-4) - T3) * T9, condmask_true0);
  ...
  dDIBL_Sft_dVd = T3 * ((float) pParam->BSIM3v32theta0vb0);
  DIBL_Sft = dDIBL_Sft_dVd * Vds;
  Vth = ((((((((((float) model->BSIM3v32type) * ((Vec8d ){heres[0]->BSIM3v32vth0, heres[1]->BSIM3v32vth0, heres[2]->BSIM3v32vth0, heres[3]->BSIM3v32vth0, heres[4]->BSIM3v32vth0, heres[5]->BSIM3v32vth0, heres[6]->BSIM3v32vth0, heres[7]->BSIM3v32vth0})) - ((float) (pParam->BSIM3v32k1 * pParam->BSIM3v32sqrtPhi))) + (((float) pParam->BSIM3v32k1ox) * sqrtPhis)) - (((float) pParam->BSIM3v32k2ox) * Vbseff)) - Delt_vth) - T2) + ((((float) pParam->BSIM3v32k3) + (((float) pParam->BSIM3v32k3b) * Vbseff)) * tmp2)) + T1) - DIBL_Sft;
  {
  ...
  dVth_dVb = ((((((((float) pParam->BSIM3v32k1ox) * dsqrtPhis_dVb) - ((float) pParam->BSIM3v32k2ox)) - dDelt_vth_dVb) - dT2_dVb) + (((float) pParam->BSIM3v32k3b) * tmp2)) - (((((float) pParam->BSIM3v32etab) * Vds) * ((float) pParam->BSIM3v32theta0vb0)) * T4)) + ((float) (pParam->BSIM3v32kt2 * TempRatio));
  dVth_dVd = -dDIBL_Sft_dVd;
  tmp2 = ((float) (pParam->BSIM3v32nfactor * EPSSI)) / Xdep;
  tmp3 = (((float) pParam->BSIM3v32cdsc) + (((float) pParam->BSIM3v32cdscb) * Vbseff)) + (((float) pParam->BSIM3v32cdscd) * Vds);
  tmp4 = ((tmp2 + (tmp3 * Theta0)) + ((float) pParam->BSIM3v32cit)) / ((float) model->BSIM3v32cox);
  if (1)
  {
    Vec8m condmask0 = tmp4 >= ((float) (-0.5));
    Vec8m condmask_true0 = condmask0;
    Vec8m condmask_false0 = ~condmask0;
    {
      n = vec8_blend(n, ((float) 1.0) + tmp4, condmask_true0);
      dn_dVb = vec8_blend(dn_dVb, (((((-tmp2) / Xdep) * dXdep_dVb) + (tmp3 * dTheta0_dVb)) + (((float) pParam->BSIM3v32cdscb) * Theta0)) / ((float) model->BSIM3v32cox), condmask_true0);
      dn_dVd = vec8_blend(dn_dVd, (((float) pParam->BSIM3v32cdscd) * Theta0) / ((float) model->BSIM3v32cox), condmask_true0);
    }
    {
      T0 = vec8_blend(T0, ((float) 1.0) / (((float) 3.0) + (((float) 8.0) * tmp4)), condmask_false0);
      n = vec8_blend(n, (((float) 1.0) + (((float) 3.0) * tmp4)) * T0, condmask_false0);
    ...
    if (1)
  {
    ...
    Vec8m condmask_true0 = condmask0;
    {
      ...
      T4 = vec8_blend(T4, vec8_sqrt(((float) 1.0) + ((((float) 2.0) * (Vgs - T0)) / T1)), condmask_true0);
      T2 = vec8_blend(T2, T1 * (T4 - ((float) 1.0)), condmask_true0);
      T3 = vec8_blend(T3, ((((float) 0.5) * T2) * T2) / T1, condmask_true0);
      T7 = vec8_blend(T7, (((float) 1.12) - T3) - ((float) 0.05), condmask_true0);
      T6 = vec8_blend(T6, vec8_sqrt((T7 * T7) + ((float) 0.224)), condmask_true0);
      T5 = vec8_blend(T5, ((float) 1.12) - (((float) 0.5) * (T7 + T6)), condmask_true0);
      Vgs_eff = vec8_blend(Vgs_eff, Vgs - T5, condmask_true0);
      dVgs_eff_dVg = vec8_blend(dVgs_eff_dVg, ((float) 1.0) - ((((float) 0.5) - (((float) 0.5) / T4)) * (((float) 1.0) + (T7 / T6))), condmask_true0);
    }
  }


  Vgst = Vgs_eff - Vth;
  T10 = (((float) 2.0) * n) * ((float) Vtm);
  VgstNVt = Vgst / T10;
  ExpArg = (((float) (2.0 * pParam->BSIM3v32voff)) - Vgst) / T10;
  T0 = VgstNVt;
  if (1)
  {
    Vec8m condmask0 = ExpArg > ((float) EXP_THRESHOLD);
    Vec8m condmask_true0 = condmask0;
    T0 = vec8_blend(T0, (Vgst - ((float) pParam->BSIM3v32voff)) / (n * ((float) Vtm)), condmask_true0);
  }

  ExpVgst = vec8_exp(T0);
  if (1)
  {
    Vec8m condmask0 = VgstNVt > ((float) EXP_THRESHOLD);
    Vec8m condmask_true0 = condmask0;
    Vec8m condmask_false0 = ~condmask0;
    {
    ...
    if (1)
    {
      Vec8m condmask1 = ExpArg > ((float) EXP_THRESHOLD);
      Vec8m condmask_true1 = condmask_false0 & condmask1;
      Vec8m condmask_false1 = condmask_false0 & (~condmask1);
      {
        Vgsteff = vec8_blend(Vgsteff, ((float) ((Vtm * pParam->BSIM3v32cdep0) / model->BSIM3v32cox)) * ExpVgst, condmask_true1);
        dVgsteff_dVg = vec8_blend(dVgsteff_dVg, Vgsteff / (n * ((float) Vtm)), condmask_true1);
        dVgsteff_dVd = vec8_blend(dVgsteff_dVd, (-dVgsteff_dVg) * (dVth_dVd + ((T0 * ((float) Vtm)) * dn_dVd)), condmask_true1);
        dVgsteff_dVb = vec8_blend(dVgsteff_dVb, (-dVgsteff_dVg) * (dVth_dVb + ((T0 * ((float) Vtm)) * dn_dVb)), condmask_true1);
        dVgsteff_dVg = vec8_blend(dVgsteff_dVg, dVgsteff_dVg * dVgs_eff_dVg, condmask_true1);
      }
      {
        T1 = vec8_blend(T1, T10 * vec8_log(((float) 1.0) + ExpVgst), condmask_false1);
        dT1_dVg = vec8_blend(dT1_dVg, ExpVgst / (((float) 1.0) + ExpVgst), condmask_false1);
        ...
        dT2_dVg = vec8_blend(dT2_dVg, ((float) ((-model->BSIM3v32cox) / (Vtm * pParam->BSIM3v32cdep0))) * vec8_exp(ExpArg), condmask_false1);
        T2 = vec8_blend(T2, ((float) 1.0) - (T10 * dT2_dVg), condmask_false1);
        dT2_dVd = vec8_blend(dT2_dVd, ((-dT2_dVg) * (dVth_dVd - ((((float) (2.0 * Vtm)) * ExpArg) * dn_dVd))) + (((T2 - ((float) 1.0)) / n) * dn_dVd), condmask_false1);
        dT2_dVb = vec8_blend(dT2_dVb, ((-dT2_dVg) * (dVth_dVb - ((((float) (2.0 * Vtm)) * ExpArg) * dn_dVb))) + (((T2 - ((float) 1.0)) / n) * dn_dVb), condmask_false1);
  ...
  T9 = sqrtPhis - ((float) pParam->BSIM3v32sqrtPhi);
  Weff = ((float) pParam->BSIM3v32weff) - (((float) 2.0) * ((((float) pParam->BSIM3v32dwg) * Vgsteff) + (((float) pParam->BSIM3v32dwb) * T9)));
  dWeff_dVg = vec8_SIMDTOVECTOR((-2.0) * pParam->BSIM3v32dwg);
  dWeff_dVb = ((float) ((-2.0) * pParam->BSIM3v32dwb)) * dsqrtPhis_dVb;
  if (1)
  {
    Vec8m condmask0 = Weff < ((float) 2.0e-8);
    Vec8m condmask_true0 = condmask0;
    {
      T0 = vec8_blend(T0, ((float) 1.0) / (((float) 6.0e-8) - (((float) 2.0) * Weff)), condmask_true0);
      Weff = vec8_blend(Weff, (((float) 2.0e-8) * (((float) 4.0e-8) - Weff)) * T0, condmask_true0);
      T0 = vec8_blend(T0, T0 * (T0 * ((float) 4.0e-16)), condmask_true0);
      dWeff_dVg = vec8_blend(dWeff_dVg, dWeff_dVg * T0, condmask_true0);
      dWeff_dVb = vec8_blend(dWeff_dVb, dWeff_dVb * T0, condmask_true0);
    }
  }

  T0 = (((float) pParam->BSIM3v32prwg) * Vgsteff) + (((float) pParam->BSIM3v32prwb) * T9);
  if (1)
  {
    Vec8m condmask0 = T0 >= ((float) (-0.9));
    Vec8m condmask_true0 = condmask0;
    Vec8m condmask_false0 = ~condmask0;
    {
      Rds = vec8_blend(Rds, ((float) pParam->BSIM3v32rds0) * (((float) 1.0) + T0), condmask_true0);
      dRds_dVg = vec8_blend(dRds_dVg, vec8_SIMDTOVECTOR(pParam->BSIM3v32rds0 * pParam->BSIM3v32prwg), condmask_true0);
      dRds_dVb = vec8_blend(dRds_dVb, ((float) (pParam->BSIM3v32rds0 * pParam->BSIM3v32prwb)) * dsqrtPhis_dVb, condmask_true0);
    }
    {
      T1 = vec8_blend(T1, ((float) 1.0) / (((float) 17.0) + (((float) 20.0) * T0)), condmask_false0);
      Rds = vec8_blend(Rds, (((float) pParam->BSIM3v32rds0) * (((float) 0.8) + T0)) * T1, condmask_false0);
      T1 = vec8_blend(T1, T1 * T1, condmask_false0);
      dRds_dVg = vec8_blend(dRds_dVg, ((float) (pParam->BSIM3v32rds0 * pParam->BSIM3v32prwg)) * T1, condmask_false0);
      dRds_dVb = vec8_blend(dRds_dVb, (((float) (pParam->BSIM3v32rds0 * pParam->BSIM3v32prwb)) * dsqrtPhis_dVb) * T1, condmask_false0);
    }
  }
  ...
  T1 = ((float) (0.5 * pParam->BSIM3v32k1ox)) / sqrtPhis;
  dT1_dVb = ((-T1) / sqrtPhis) * dsqrtPhis_dVb;
  T9 = vec8_sqrt(((float) pParam->BSIM3v32xj) * Xdep);
  tmp1 = ((float) Leff) + (((float) 2.0) * T9);
  T5 = ((float) Leff) / tmp1;
  tmp2 = ((float) pParam->BSIM3v32a0) * T5;
  tmp3 = vec8_SIMDTOVECTOR(pParam->BSIM3v32weff + pParam->BSIM3v32b1);
  tmp4 = ((float) pParam->BSIM3v32b0) / tmp3;
  T2 = tmp2 + tmp4;
  dT2_dVb = (((-T9) / tmp1) / Xdep) * dXdep_dVb;
  T6 = T5 * T5;
  T7 = T5 * T6;
  Abulk0 = ((float) 1.0) + (T1 * T2);
  dAbulk0_dVb = ((T1 * tmp2) * dT2_dVb) + (T2 * dT1_dVb);
  T8 = ((float) (pParam->BSIM3v32ags * pParam->BSIM3v32a0)) * T7;
  dAbulk_dVg = (-T1) * T8;
  Abulk = Abulk0 + (dAbulk_dVg * Vgsteff);
  dAbulk_dVb = dAbulk0_dVb - ((T8 * Vgsteff) * (dT1_dVb + ((((float) 3.0) * T1) * dT2_dVb)));
  if (1)
  {
    Vec8m condmask0 = Abulk0 < ((float) 0.1);
    Vec8m condmask_true0 = condmask0;
    {
      T9 = vec8_blend(T9, ((float) 1.0) / (((float) 3.0) - (((float) 20.0) * Abulk0)), condmask_true0);
      Abulk0 = vec8_blend(Abulk0, (((float) 0.2) - Abulk0) * T9, condmask_true0);
  ...
  if (1)
  {
    Vec8m condmask0 = Abulk < ((float) 0.1);
    Vec8m condmask_true0 = condmask0;
    {
      T9 = vec8_blend(T9, ((float) 1.0) / (((float) 3.0) - (((float) 20.0) * Abulk)), condmask_true0);
      Abulk = vec8_blend(Abulk, (((float) 0.2) - Abulk) * T9, condmask_true0);
  ...
  T2 = ((float) pParam->BSIM3v32keta) * Vbseff;
  if (1)
  {
    Vec8m condmask0 = T2 >= ((float) (-0.9));
    Vec8m condmask_true0 = condmask0;
    Vec8m condmask_false0 = ~condmask0;
    {
      T0 = vec8_blend(T0, ((float) 1.0) / (((float) 1.0) + T2), condmask_true0);
      dT0_dVb = vec8_blend(dT0_dVb, (((float) (-pParam->BSIM3v32keta)) * T0) * T0, condmask_true0);
    }
    {
      T1 = vec8_blend(T1, ((float) 1.0) / (((float) 0.8) + T2), condmask_false0);
      T0 = vec8_blend(T0, (((float) 17.0) + (((float) 20.0) * T2)) * T1, condmask_false0);
      dT0_dVb = vec8_blend(dT0_dVb, (((float) (-pParam->BSIM3v32keta)) * T1) * T1, condmask_false0);
    }
  }
  ...
  {
    T0 = (Vgsteff + Vth) + Vth;
    T2 = ((float) pParam->BSIM3v32ua) + (((float) pParam->BSIM3v32uc) * Vbseff);
    T3 = T0 / ((float) model->BSIM3v32tox);
    T5 = T3 * (T2 + (((float) pParam->BSIM3v32ub) * T3));
    dDenomi_dVg = (T2 + (((float) (2.0 * pParam->BSIM3v32ub)) * T3)) / ((float) model->BSIM3v32tox);
    dDenomi_dVd = (dDenomi_dVg * ((float) 2.0)) * dVth_dVd;
    dDenomi_dVb = ((dDenomi_dVg * ((float) 2.0)) * dVth_dVb) + (((float) pParam->BSIM3v32uc) * T3);
  }
  else
    if (model->BSIM3v32mobMod == 2)
  {
    T5 = (Vgsteff / ((float) model->BSIM3v32tox)) * ((((float) pParam->BSIM3v32ua) + (((float) pParam->BSIM3v32uc) * Vbseff)) + ((((float) pParam->BSIM3v32ub) * Vgsteff) / ((float) model->BSIM3v32tox)));
    dDenomi_dVg = ((((float) pParam->BSIM3v32ua) + (((float) pParam->BSIM3v32uc) * Vbseff)) + ((((float) (2.0 * pParam->BSIM3v32ub)) * Vgsteff) / ((float) model->BSIM3v32tox))) / ((float) model->BSIM3v32tox);
    dDenomi_dVd = vec8_SIMDTOVECTOR(0.0);
    dDenomi_dVb = (Vgsteff * ((float) pParam->BSIM3v32uc)) / ((float) model->BSIM3v32tox);
  }
  else
  {
    T0 = (Vgsteff + Vth) + Vth;
    T2 = ((float) 1.0) + (((float) pParam->BSIM3v32uc) * Vbseff);
    T3 = T0 / ((float) model->BSIM3v32tox);
    T4 = T3 * (((float) pParam->BSIM3v32ua) + (((float) pParam->BSIM3v32ub) * T3));
    T5 = T4 * T2;
    dDenomi_dVg = ((((float) pParam->BSIM3v32ua) + (((float) (2.0 * pParam->BSIM3v32ub)) * T3)) * T2) / ((float) model->BSIM3v32tox);
    dDenomi_dVd = (dDenomi_dVg * ((float) 2.0)) * dVth_dVd;
    dDenomi_dVb = ((dDenomi_dVg * ((float) 2.0)) * dVth_dVb) + (((float) pParam->BSIM3v32uc) * T4);
  }


  if (1)
  {
    Vec8m condmask0 = T5 >= ((float) (-0.8));
    Vec8m condmask_true0 = condmask0;
    Vec8m condmask_false0 = ~condmask0;
    {
      Denomi = vec8_blend(Denomi, ((float) 1.0) + T5, condmask_true0);
    }
    {
      T9 = vec8_blend(T9, ((float) 1.0) / (((float) 7.0) + (((float) 10.0) * T5)), condmask_false0);
      Denomi = vec8_blend(Denomi, (((float) 0.6) + T5) * T9, condmask_false0);
  ...
  WVCox = (Weff * ((float) pParam->BSIM3v32vsattemp)) * ((float) model->BSIM3v32cox);
  WVCoxRds = WVCox * Rds;
  Esat = ((float) (2.0 * pParam->BSIM3v32vsattemp)) / ueff;
  EsatL = Esat * ((float) Leff);
  T0 = (-EsatL) / ueff;
    ...
    if (a1 > 0.0)
  {
    ...
    T1 = (T0 - (((float) pParam->BSIM3v32a1) * Vgsteff)) - ((float) 0.0001);
    T2 = vec8_sqrt((T1 * T1) + (((float) 0.0004) * T0));
    Lambda = (((float) pParam->BSIM3v32a2) + T0) - (((float) 0.5) * (T1 + T2));
    dLambda_dVg = ((float) (0.5 * pParam->BSIM3v32a1)) * (((float) 1.0) + (T1 / T2));
  }
  else
  {
    T1 = (((float) pParam->BSIM3v32a2) + (((float) pParam->BSIM3v32a1) * Vgsteff)) - ((float) 0.0001);
    T2 = vec8_sqrt((T1 * T1) + ((float) (0.0004 * pParam->BSIM3v32a2)));
    Lambda = ((float) 0.5) * (T1 + T2);
    dLambda_dVg = ((float) (0.5 * pParam->BSIM3v32a1)) * (((float) 1.0) + (T1 / T2));
  }


  Vgst2Vtm = Vgsteff + ((float) (2.0 * Vtm));
  if (model->BSIM3v32intVersion > BSIM3v32V323)
  {
    {
  ...
  if (1)
  {
    Vec8m condmask0 = (Rds == ((float) 0.0)) & (Lambda == ((float) 1.0));
    Vec8m condmask_true0 = condmask0;
    Vec8m condmask_false0 = ~condmask0;
    {
      T0 = vec8_blend(T0, ((float) 1.0) / ((Abulk * EsatL) + Vgst2Vtm), condmask_true0);
      ...
      dT0_dVg = vec8_blend(dT0_dVg, (-(((Abulk * dEsatL_dVg) + (EsatL * dAbulk_dVg)) + ((float) 1.0))) * T1, condmask_true0);
    ...
    }
    {
      ...
      T0 = vec8_blend(T0, (((float) 2.0) * Abulk) * ((T9 - ((float) 1.0)) + (((float) 1.0) / Lambda)), condmask_false0);
      dT0_dVg = vec8_blend(dT0_dVg, ((float) 2.0) * (((T8 * tmp2) - (Abulk * tmp1)) + ((((((float) 2.0) * T9) + (((float) 1.0) / Lambda)) - ((float) 1.0)) * dAbulk_dVg)), condmask_false0);
      dT0_dVb = vec8_blend(dT0_dVb, ((float) 2.0) * ((T8 * (((((float) 2.0) / Abulk) * dAbulk_dVb) + tmp3)) + (((((float) 1.0) / Lambda) - ((float) 1.0)) * dAbulk_dVb)), condmask_false0);
      dT0_dVd = vec8_blend(dT0_dVd, vec8_SIMDTOVECTOR(0.0), condmask_false0);
      T1 = vec8_blend(T1, ((Vgst2Vtm * ((((float) 2.0) / Lambda) - ((float) 1.0))) + (Abulk * EsatL)) + (((float) 3.0) * T7), condmask_false0);
      dT1_dVg = vec8_blend(dT1_dVg, (((((((float) 2.0) / Lambda) - ((float) 1.0)) - ((((float) 2.0) * Vgst2Vtm) * tmp1)) + (Abulk * dEsatL_dVg)) + (EsatL * dAbulk_dVg)) + (((float) 3.0) * ((T9 + (T7 * tmp2)) + (T6 * dAbulk_dVg))), condmask_false0);
      dT1_dVb = vec8_blend(dT1_dVb, ((Abulk * dEsatL_dVb) + (EsatL * dAbulk_dVb)) + (((float) 3.0) * ((T6 * dAbulk_dVb) + (T7 * tmp3))), condmask_false0);
      dT1_dVd = vec8_blend(dT1_dVd, Abulk * dEsatL_dVd, condmask_false0);
      T2 = vec8_blend(T2, Vgst2Vtm * (EsatL + (((float) 2.0) * T6)), condmask_false0);
      dT2_dVg = vec8_blend(dT2_dVg, (EsatL + (Vgst2Vtm * dEsatL_dVg)) + (T6 * (((float) 4.0) + ((((float) 2.0) * Vgst2Vtm) * tmp2))), condmask_false0);
      dT2_dVb = vec8_blend(dT2_dVb, Vgst2Vtm * (dEsatL_dVb + ((((float) 2.0) * T6) * tmp3)), condmask_false0);
      dT2_dVd = vec8_blend(dT2_dVd, Vgst2Vtm * dEsatL_dVd, condmask_false0);
      T3 = vec8_blend(T3, vec8_sqrt((T1 * T1) - ((((float) 2.0) * T0) * T2)), condmask_false0);
      Vdsat = vec8_blend(Vdsat, (T1 - T3) / T0, condmask_false0);
      dT3_dVg = vec8_blend(dT3_dVg, ((T1 * dT1_dVg) - (((float) 2.0) * ((T0 * dT2_dVg) + (T2 * dT0_dVg)))) / T3, condmask_false0);
      dT3_dVd = vec8_blend(dT3_dVd, ((T1 * dT1_dVd) - (((float) 2.0) * ((T0 * dT2_dVd) + (T2 * dT0_dVd)))) / T3, condmask_false0);
      dT3_dVb = vec8_blend(dT3_dVb, ((T1 * dT1_dVb) - (((float) 2.0) * ((T0 * dT2_dVb) + (T2 * dT0_dVb)))) / T3, condmask_false0);
  ...
  T1 = (Vdsat - Vds) - ((float) pParam->BSIM3v32delta);
  dT1_dVg = dVdsat_dVg;
  dT1_dVd = dVdsat_dVd - ((float) 1.0);
  dT1_dVb = dVdsat_dVb;
  T2 = vec8_sqrt((T1 * T1) + (((float) (4.0 * pParam->BSIM3v32delta)) * Vdsat));
  T0 = T1 / T2;
  T3 = ((float) (2.0 * pParam->BSIM3v32delta)) / T2;
  dT2_dVg = (T0 * dT1_dVg) + (T3 * dVdsat_dVg);
  dT2_dVd = (T0 * dT1_dVd) + (T3 * dVdsat_dVd);
  dT2_dVb = (T0 * dT1_dVb) + (T3 * dVdsat_dVb);
  Vdseff = Vdsat - (((float) 0.5) * (T1 + T2));
  dVdseff_dVg = dVdsat_dVg - (((float) 0.5) * (dT1_dVg + dT2_dVg));
  dVdseff_dVd = dVdsat_dVd - (((float) 0.5) * (dT1_dVd + dT2_dVd));
  dVdseff_dVb = dVdsat_dVb - (((float) 0.5) * (dT1_dVb + dT2_dVb));
  switch (model->BSIM3v32intVersion)
  {
    case BSIM3v32V324:
  ...
  tmp4 = ((float) 1.0) - (((((float) 0.5) * Abulk) * Vdsat) / Vgst2Vtm);
  T9 = WVCoxRds * Vgsteff;
  T8 = T9 / Vgst2Vtm;
  T0 = (EsatL + Vdsat) + ((((float) 2.0) * T9) * tmp4);
  T7 = (((float) 2.0) * WVCoxRds) * tmp4;
  dT0_dVg = ((dEsatL_dVg + dVdsat_dVg) + (T7 * (((float) 1.0) + (tmp2 * Vgsteff)))) - (T8 * (((Abulk * dVdsat_dVg) - ((Abulk * Vdsat) / Vgst2Vtm)) + (Vdsat * dAbulk_dVg)));
  dT0_dVb = ((dEsatL_dVb + dVdsat_dVb) + ((T7 * tmp3) * Vgsteff)) - (T8 * ((dAbulk_dVb * Vdsat) + (Abulk * dVdsat_dVb)));
  dT0_dVd = (dEsatL_dVd + dVdsat_dVd) - ((T8 * Abulk) * dVdsat_dVd);
  T9 = WVCoxRds * Abulk;
  T1 = ((((float) 2.0) / Lambda) - ((float) 1.0)) + T9;
  dT1_dVg = (((float) (-2.0)) * tmp1) + (WVCoxRds * ((Abulk * tmp2) + dAbulk_dVg));
  ...
  if (pParam->BSIM3v32pclm > 0.0)
    if (1)
  {
    Vec8m condmask0 = diffVds > ((float) 1.0e-10);
    Vec8m condmask_true0 = condmask0;
    {
      ...
      T1 = vec8_blend(T1, ((float) Leff) * (Abulk + T2), condmask_true0);
      dT1_dVg = vec8_blend(dT1_dVg, ((float) Leff) * (((((float) 1.0) - (T2 * dEsatL_dVg)) / EsatL) + dAbulk_dVg), condmask_true0);
      dT1_dVb = vec8_blend(dT1_dVb, ((float) Leff) * (dAbulk_dVb - ((T2 * dEsatL_dVb) / EsatL)), condmask_true0);
      ...
      dVACLM_dVd = vec8_blend(dVACLM_dVd, ((T0 * dT1_dVd) * diffVds) + (T9 * (((float) 1.0) - dVdseff_dVd)), condmask_true0);
    }
  }
  ...
  if (pParam->BSIM3v32thetaRout > 0.0)
  {
    ...
    T1 = Vgst2Vtm + T8;
    dT1_dVg = (((float) 1.0) + (Abulk * dVdsat_dVg)) + (Vdsat * dAbulk_dVg);
    dT1_dVb = (Abulk * dVdsat_dVb) + (dAbulk_dVb * Vdsat);
    dT1_dVd = Abulk * dVdsat_dVd;
    T9 = T1 * T1;
    T2 = vec8_SIMDTOVECTOR(pParam->BSIM3v32thetaRout);
    VADIBL = (Vgst2Vtm - (T0 / T1)) / T2;
    dVADIBL_dVg = ((((float) 1.0) - (dT0_dVg / T1)) + ((T0 * dT1_dVg) / T9)) / T2;
    dVADIBL_dVb = (((-dT0_dVb) / T1) + ((T0 * dT1_dVb) / T9)) / T2;
    dVADIBL_dVd = (((-dT0_dVd) / T1) + ((T0 * dT1_dVd) / T9)) / T2;
    T7 = ((float) pParam->BSIM3v32pdiblb) * Vbseff;
    if (1)
    {
      Vec8m condmask0 = T7 >= ((float) (-0.9));
      Vec8m condmask_true0 = condmask0;
      Vec8m condmask_false0 = ~condmask0;
      {
        T3 = vec8_blend(T3, ((float) 1.0) / (((float) 1.0) + T7), condmask_true0);
        VADIBL = vec8_blend(VADIBL, VADIBL * T3, condmask_true0);
        dVADIBL_dVg = vec8_blend(dVADIBL_dVg, dVADIBL_dVg * T3, condmask_true0);
        dVADIBL_dVb = vec8_blend(dVADIBL_dVb, (dVADIBL_dVb - (VADIBL * ((float) pParam->BSIM3v32pdiblb))) * T3, condmask_true0);
        dVADIBL_dVd = vec8_blend(dVADIBL_dVd, dVADIBL_dVd * T3, condmask_true0);
      }
      {
        T4 = vec8_blend(T4, ((float) 1.0) / (((float) 0.8) + T7), condmask_false0);
        T3 = vec8_blend(T3, (((float) 17.0) + (((float) 20.0) * T7)) * T4, condmask_false0);
        dVADIBL_dVg = vec8_blend(dVADIBL_dVg, dVADIBL_dVg * T3, condmask_false0);
        dVADIBL_dVb = vec8_blend(dVADIBL_dVb, (dVADIBL_dVb * T3) - (((VADIBL * ((float) pParam->BSIM3v32pdiblb)) * T4) * T4), condmask_false0);
  ...
  T8 = ((float) pParam->BSIM3v32pvag) / EsatL;
  T9 = T8 * Vgsteff;
  if (1)
  {
    Vec8m condmask0 = T9 > ((float) (-0.9));
    Vec8m condmask_true0 = condmask0;
    Vec8m condmask_false0 = ~condmask0;
    {
      T0 = vec8_blend(T0, ((float) 1.0) + T9, condmask_true0);
      dT0_dVg = vec8_blend(dT0_dVg, T8 * (((float) 1.0) - ((Vgsteff * dEsatL_dVg) / EsatL)), condmask_true0);
    ...
    {
      T1 = vec8_blend(T1, ((float) 1.0) / (((float) 17.0) + (((float) 20.0) * T9)), condmask_false0);
      T0 = vec8_blend(T0, (((float) 0.8) + T9) * T1, condmask_false0);
      T1 = vec8_blend(T1, T1 * T1, condmask_false0);
      dT0_dVg = vec8_blend(dT0_dVg, (T8 * (((float) 1.0) - ((Vgsteff * dEsatL_dVg) / EsatL))) * T1, condmask_false0);
  ...
  if (pParam->BSIM3v32pscbe2 > 0.0)
  {
    if (1)
    {
      Vec8m condmask0 = diffVds > ((float) ((pParam->BSIM3v32pscbe1 * pParam->BSIM3v32litl) / EXP_THRESHOLD));
      Vec8m condmask_true0 = condmask0;
      Vec8m condmask_false0 = ~condmask0;
      {
        T0 = vec8_blend(T0, ((float) (pParam->BSIM3v32pscbe1 * pParam->BSIM3v32litl)) / diffVds, condmask_true0);
        VASCBE = vec8_blend(VASCBE, (((float) Leff) * vec8_exp(T0)) / ((float) pParam->BSIM3v32pscbe2), condmask_true0);
        T1 = vec8_blend(T1, (T0 * VASCBE) / diffVds, condmask_true0);
        dVASCBE_dVg = vec8_blend(dVASCBE_dVg, T1 * dVdseff_dVg, condmask_true0);
        dVASCBE_dVd = vec8_blend(dVASCBE_dVd, (-T1) * (((float) 1.0) - dVdseff_dVd), condmask_true0);
  ...
  CoxWovL = (((float) model->BSIM3v32cox) * Weff) / ((float) Leff);
  beta = ueff * CoxWovL;
  dbeta_dVg = (CoxWovL * dueff_dVg) + ((beta * dWeff_dVg) / Weff);
  dbeta_dVd = CoxWovL * dueff_dVd;
  dbeta_dVb = (CoxWovL * dueff_dVb) + ((beta * dWeff_dVb) / Weff);
  T0 = ((float) 1.0) - (((((float) 0.5) * Abulk) * Vdseff) / Vgst2Vtm);
  dT0_dVg = (((float) (-0.5)) * (((Abulk * dVdseff_dVg) - ((Abulk * Vdseff) / Vgst2Vtm)) + (Vdseff * dAbulk_dVg))) / Vgst2Vtm;
  dT0_dVd = ((((float) (-0.5)) * Abulk) * dVdseff_dVd) / Vgst2Vtm;
  dT0_dVb = (((float) (-0.5)) * ((Abulk * dVdseff_dVb) + (dAbulk_dVb * Vdseff))) / Vgst2Vtm;
  fgche1 = Vgsteff * T0;
  ...
  dIdsa_dVd = (T0 * dIdl_dVd) + ((Idl * ((((float) 1.0) - dVdseff_dVd) - (T9 * dVa_dVd))) / Va);
  dIdsa_dVb = (T0 * dIdl_dVb) - ((Idl * (dVdseff_dVb + (T9 * dVa_dVb))) / Va);
  T9 = diffVds / VASCBE;
  T0 = ((float) 1.0) + T9;
  Ids = Idsa * T0;
  Gm = (T0 * dIdsa_dVg) - ((Idsa * (dVdseff_dVg + (T9 * dVASCBE_dVg))) / VASCBE);
  Gds = (T0 * dIdsa_dVd) + ((Idsa * ((((float) 1.0) - dVdseff_dVd) - (T9 * dVASCBE_dVd))) / VASCBE);
  ...
  else
  {
    ...
    if (1)
    {
      Vec8m condmask0 = diffVds > ((float) (pParam->BSIM3v32beta0 / EXP_THRESHOLD));
      Vec8m condmask_true0 = condmask0;
      Vec8m condmask_false0 = ~condmask0;
      {
        T0 = vec8_blend(T0, ((float) (-pParam->BSIM3v32beta0)) / diffVds, condmask_true0);
        T1 = vec8_blend(T1, (T2 * diffVds) * vec8_exp(T0), condmask_true0);
        T3 = vec8_blend(T3, (T1 / diffVds) * (T0 - ((float) 1.0)), condmask_true0);
        dT1_dVg = vec8_blend(dT1_dVg, T3 * dVdseff_dVg, condmask_true0);
        dT1_dVd = vec8_blend(dT1_dVd, T3 * (dVdseff_dVd - ((float) 1.0)), condmask_true0);
        dT1_dVb = vec8_blend(dT1_dVb, T3 * dVdseff_dVb, condmask_true0);
      }
      {
        T3 = vec8_blend(T3, T2 * ((float) MIN_EXP), condmask_false0);
        T1 = vec8_blend(T1, T3 * diffVds, condmask_false0);
        dT1_dVg = vec8_blend(dT1_dVg, (-T3) * dVdseff_dVg, condmask_false0);
        dT1_dVd = vec8_blend(dT1_dVd, T3 * (((float) 1.0) - dVdseff_dVd), condmask_false0);
    ...
    if (model->BSIM3v32capMod == 0)
  {
    if (1)
    {
      ...
      {
        Vbseff = vec8_blend(Vbseff, ((float) pParam->BSIM3v32phi) - Phis, condmask_false0);
        dVbseff_dVb = vec8_blend(dVbseff_dVb, -dPhis_dVb, condmask_false0);
      }
    }

    Vfb = vec8_SIMDTOVECTOR(pParam->BSIM3v32vfbcv);
    Vth = (Vfb + ((float) pParam->BSIM3v32phi)) + (((float) pParam->BSIM3v32k1ox) * sqrtPhis);
    Vgst = Vgs_eff - Vth;
    dVth_dVb = ((float) pParam->BSIM3v32k1ox) * dsqrtPhis_dVb;
    dVgst_dVb = -dVth_dVb;
    dVgst_dVg = dVgs_eff_dVg;
    Arg1 = (Vgs_eff - Vbseff) - Vfb;
    if (1)
    {
      Vec8m condmask0 = Arg1 <= ((float) 0.0);
      Vec8m condmask_true0 = condmask0;
      Vec8m condmask_false0 = ~condmask0;
      {
        qgate = vec8_blend(qgate, ((float) CoxWL) * Arg1, condmask_true0);
        qbulk = vec8_blend(qbulk, -qgate, condmask_true0);
        qdrn = vec8_blend(qdrn, vec8_SIMDTOVECTOR(0.0), condmask_true0);
        {
          Vec8d val = ((float) CoxWL) * dVgs_eff_dVg;
          if (condmask_true0[0])
        ...
        {
          Vec8d val = ((float) CoxWL) * (dVbseff_dVb - dVgs_eff_dVg);
          if (condmask_true0[0])
      ...
      if (1)
      {
        Vec8m condmask1 = Vgst <= ((float) 0.0);
        Vec8m condmask_true1 = condmask_false0 & condmask1;
        Vec8m condmask_false1 = condmask_false0 & (~condmask1);
        {
          ...
          qgate = vec8_blend(qgate, ((float) (CoxWL * pParam->BSIM3v32k1ox)) * (T2 - T1), condmask_true1);
          qbulk = vec8_blend(qbulk, -qgate, condmask_true1);
          qdrn = vec8_blend(qdrn, vec8_SIMDTOVECTOR(0.0), condmask_true1);
          T0 = vec8_blend(T0, (((float) CoxWL) * T1) / T2, condmask_true1);
          {
        ...
        {
          AbulkCV = vec8_blend(AbulkCV, Abulk0 * ((float) pParam->BSIM3v32abulkCVfactor), condmask_false1);
          dAbulkCV_dVb = vec8_blend(dAbulkCV_dVb, ((float) pParam->BSIM3v32abulkCVfactor) * dAbulk0_dVb, condmask_false1);
          ...
          if (model->BSIM3v32xpart > 0.5)
          {
            if (1)
            {
              ...
              {
                T1 = vec8_blend(T1, Vdsat / ((float) 3.0), condmask_true2);
                qgate = vec8_blend(qgate, ((float) CoxWL) * (((Vgs_eff - Vfb) - ((float) pParam->BSIM3v32phi)) - T1), condmask_true2);
                T2 = vec8_blend(T2, ((float) (-Two_Third_CoxWL)) * Vgst, condmask_true2);
                qbulk = vec8_blend(qbulk, -(qgate + T2), condmask_true2);
                qdrn = vec8_blend(qdrn, vec8_SIMDTOVECTOR(0.0), condmask_true2);
                {
                  Vec8d val = (((float) One_Third_CoxWL) * (((float) 3.0) - dVdsat_dVg)) * dVgs_eff_dVg;
                  if (condmask_true2[0])
                    heres[0]->BSIM3v32cggb = val[0];
                ...
                T2 = vec8_blend(T2, ((float) (-One_Third_CoxWL)) * dVdsat_dVb, condmask_true2);
                {
                ...
                {
                  Vec8d val = -(((Vec8d ){heres[0]->BSIM3v32cggb, heres[1]->BSIM3v32cggb, heres[2]->BSIM3v32cggb, heres[3]->BSIM3v32cggb, heres[4]->BSIM3v32cggb, heres[5]->BSIM3v32cggb, heres[6]->BSIM3v32cggb, heres[7]->BSIM3v32cggb}) - (((float) Two_Third_CoxWL) * dVgs_eff_dVg));
                  if (condmask_true2[0])
                    heres[0]->BSIM3v32cbgb = val[0];
                ...
                T3 = vec8_blend(T3, -(T2 + (((float) Two_Third_CoxWL) * dVth_dVb)), condmask_true2);
                {
              ...
              }
              {
                ...
                T1 = vec8_blend(T1, (((float) 2.0) * Vdsat) - Vds, condmask_false2);
                T2 = vec8_blend(T2, Vds / (((float) 3.0) * T1), condmask_false2);
                ...
                T7 = vec8_blend(T7, ((((float) 2.0) * Vds) - T1) - (((float) 3.0) * T3), condmask_false2);
                T8 = vec8_blend(T8, (T3 - T1) - (((float) 2.0) * Vds), condmask_false2);
                qgate = vec8_blend(qgate, ((float) CoxWL) * (((Vgs_eff - Vfb) - ((float) pParam->BSIM3v32phi)) - (((float) 0.5) * (Vds - T3))), condmask_false2);
                ...
                {
                  Vec8d val = (((float) CoxWL) * (((float) 1.0) - (T5 * dVdsat_dVg))) * dVgs_eff_dVg;
                ...
                T11 = vec8_blend(T11, (((float) (-CoxWL)) * T5) * dVdsat_dVb, condmask_false2);
                {
                  Vec8d val = ((float) CoxWL) * ((T2 - ((float) 0.5)) + (((float) 0.5) * T5));
                  if (condmask_false2[0])
                ...
                T6 = vec8_blend(T6, ((float) 1.0) / Vdsat, condmask_false2);
                dAlphaz_dVg = vec8_blend(dAlphaz_dVg, T6 * (((float) 1.0) - (Alphaz * dVdsat_dVg)), condmask_false2);
                ...
                T9 = vec8_blend(T9, (((float) 2.0) * T4) * (((float) 1.0) - (((float) 3.0) * T5)), condmask_false2);
                {
                ...
                {
                  Vec8d val = T4 * ((((float) 3.0) - (((float) 6.0) * T2)) - (((float) 3.0) * T5));
                  if (condmask_false2[0])
                ...
                T9 = vec8_blend(T9, (((float) 2.0) * T4) * (((float) 1.0) + T5), condmask_false2);
                ...
                T12 = vec8_blend(T12, T4 * (((((float) 2.0) * T2) + T5) - ((float) 1.0)), condmask_false2);
            ...
            if (model->BSIM3v32xpart < 0.5)
          {
            if (1)
            {
              ...
              Vec8m condmask_false2 = condmask_false1 & (~condmask2);
              {
                ...
                T2 = vec8_blend(T2, ((float) (-Two_Third_CoxWL)) * Vgst, condmask_true2);
                qbulk = vec8_blend(qbulk, -(qgate + T2), condmask_true2);
                qdrn = vec8_blend(qdrn, ((float) 0.4) * T2, condmask_true2);
                {
                  Vec8d val = (((float) One_Third_CoxWL) * (((float) 3.0) - dVdsat_dVg)) * dVgs_eff_dVg;
                  if (condmask_true2[0])
                    heres[0]->BSIM3v32cggb = val[0];
              ...
              }
              {
                ...
                tmp = vec8_blend(tmp, (((float) (-CoxWL)) * T5) * dVdsat_dVb, condmask_false2);
                {
                  Vec8d val = ((float) CoxWL) * ((T2 - ((float) 0.5)) + (((float) 0.5) * T5));
                  if (condmask_false2[0])
                    heres[0]->BSIM3v32cgdb = val[0];
                ...
                dAlphaz_dVg = vec8_blend(dAlphaz_dVg, T6 * (((float) 1.0) - (Alphaz * dVdsat_dVg)), condmask_false2);
                dAlphaz_dVb = vec8_blend(dAlphaz_dVb, (-T6) * (dVth_dVb + (Alphaz * dVdsat_dVb)), condmask_false2);
                T6 = vec8_blend(T6, (((((float) 8.0) * Vdsat) * Vdsat) - ((((float) 6.0) * Vdsat) * Vds)) + ((((float) 1.2) * Vds) * Vds), condmask_false2);
                ...
                tmp1 = vec8_blend(tmp1, T4 * ((((float) 2.0) - ((((float) 4.0) * tmp) * T6)) + (T8 * ((((float) 16.0) * Vdsat) - (((float) 6.0) * Vds)))), condmask_false2);
                {
                ...
                {
                  Vec8d val = T4 * ((((float) 2.0) - (((((float) 1.0) / ((((float) 3.0) * T1) * T1)) + (((float) 2.0) * tmp)) * T6)) + (T8 * ((((float) 6.0) * Vdsat) - (((float) 2.4) * Vds))));
                  if (condmask_false2[0])
                    heres[0]->BSIM3v32cddb = val[0];
                ...
                T7 = vec8_blend(T7, ((float) 2.0) * (T1 + T3), condmask_false2);
                qbulk = vec8_blend(qbulk, -(qgate - (T4 * T7)), condmask_false2);
                T7 = vec8_blend(T7, T7 * T9, condmask_false2);
                T0 = vec8_blend(T0, (((float) 4.0) * T4) * (((float) 1.0) - T5), condmask_false2);
                ...
                T10 = vec8_blend(T10, ((((float) (-4.0)) * T4) * ((T2 - ((float) 0.5)) + (((float) 0.5) * T5))) - ((Vec8d ){heres[0]->BSIM3v32cddb, heres[1]->BSIM3v32cddb, heres[2]->BSIM3v32cddb, heres[3]->BSIM3v32cddb, heres[4]->BSIM3v32cddb, heres[5]->BSIM3v32cddb, heres[6]->BSIM3v32cddb, heres[7]->BSIM3v32cddb}), condmask_false2);
          ...
          else
          {
            if (1)
            {
              ...
              Vec8m condmask_false2 = condmask_false1 & (~condmask2);
              {
                ...
                T2 = vec8_blend(T2, ((float) (-Two_Third_CoxWL)) * Vgst, condmask_true2);
                qbulk = vec8_blend(qbulk, -(qgate + T2), condmask_true2);
                qdrn = vec8_blend(qdrn, ((float) 0.5) * T2, condmask_true2);
                {
                  Vec8d val = (((float) One_Third_CoxWL) * (((float) 3.0) - dVdsat_dVg)) * dVgs_eff_dVg;
                  if (condmask_true2[0])
                    heres[0]->BSIM3v32cggb = val[0];
                ...
                {
                  Vec8d val = ((float) (-One_Third_CoxWL)) * dVgs_eff_dVg;
                  if (condmask_true2[0])
                    heres[0]->BSIM3v32cdgb = val[0];
                ...
                T4 = vec8_blend(T4, ((float) One_Third_CoxWL) * dVth_dVb, condmask_true2);
                {
                  Vec8d val = -(T4 + ((Vec8d ){heres[0]->BSIM3v32cdgb, heres[1]->BSIM3v32cdgb, heres[2]->BSIM3v32cdgb, heres[3]->BSIM3v32cdgb, heres[4]->BSIM3v32cdgb, heres[5]->BSIM3v32cdgb, heres[6]->BSIM3v32cdgb, heres[7]->BSIM3v32cdgb}));
                  if (condmask_true2[0])
                    heres[0]->BSIM3v32cdsb = val[0];
              ...
              }
              {
                ...
                T7 = vec8_blend(T7, T7 * T9, condmask_false2);
                T0 = vec8_blend(T0, T4 * ((((float) 2.0) * T5) - ((float) 2.0)), condmask_false2);
                {
                ...
                {
                  Vec8d val = T4 * ((((float) 1.0) - (((float) 2.0) * T2)) - T5);
                  if (condmask_false2[0])
                    heres[0]->BSIM3v32cddb = val[0];
                ...
                {
                  Vec8d val = -(((Vec8d ){heres[0]->BSIM3v32cgdb, heres[1]->BSIM3v32cgdb, heres[2]->BSIM3v32cgdb, heres[3]->BSIM3v32cgdb, heres[4]->BSIM3v32cgdb, heres[5]->BSIM3v32cgdb, heres[6]->BSIM3v32cgdb, heres[7]->BSIM3v32cgdb}) + (((float) 2.0) * ((Vec8d ){heres[0]->BSIM3v32cddb, heres[1]->BSIM3v32cddb, heres[2]->BSIM3v32cddb, heres[3]->BSIM3v32cddb, heres[4]->BSIM3v32cddb, heres[5]->BSIM3v32cddb, heres[6]->BSIM3v32cddb, heres[7]->BSIM3v32cddb})));
                  if (condmask_false2[0])
                    heres[0]->BSIM3v32cbdb = val[0];
                ...
                {
                  Vec8d val = -(((Vec8d ){heres[0]->BSIM3v32cgsb, heres[1]->BSIM3v32cgsb, heres[2]->BSIM3v32cgsb, heres[3]->BSIM3v32cgsb, heres[4]->BSIM3v32cgsb, heres[5]->BSIM3v32cgsb, heres[6]->BSIM3v32cgsb, heres[7]->BSIM3v32cgsb}) + (((float) 2.0) * ((Vec8d ){heres[0]->BSIM3v32cdsb, heres[1]->BSIM3v32cdsb, heres[2]->BSIM3v32cdsb, heres[3]->BSIM3v32cdsb, heres[4]->BSIM3v32cdsb, heres[5]->BSIM3v32cdsb, heres[6]->BSIM3v32cdsb, heres[7]->BSIM3v32cdsb})));
                  if (condmask_false2[0])
                    heres[0]->BSIM3v32cbsb = val[0];
  ...
  else
  {
    if (1)
    {
      ...
      {
        VbseffCV = vec8_blend(VbseffCV, ((float) pParam->BSIM3v32phi) - Phis, condmask_false0);
        dVbseffCV_dVb = vec8_blend(dVbseffCV_dVb, -dPhis_dVb, condmask_false0);
      }
    }

    noff = n * ((float) pParam->BSIM3v32noff);
    dnoff_dVd = ((float) pParam->BSIM3v32noff) * dn_dVd;
    dnoff_dVb = ((float) pParam->BSIM3v32noff) * dn_dVb;
    T0 = ((float) Vtm) * noff;
    voffcv = pParam->BSIM3v32voffcv;
    VgstNVt = (Vgst - ((float) voffcv)) / T0;
    if (1)
    {
      Vec8m condmask0 = VgstNVt > ((float) EXP_THRESHOLD);
      Vec8m condmask_true0 = condmask0;
      Vec8m condmask_false0 = ~condmask0;
      {
        Vgsteff = vec8_blend(Vgsteff, Vgst - ((float) voffcv), condmask_true0);
        dVgsteff_dVg = vec8_blend(dVgsteff_dVg, dVgs_eff_dVg, condmask_true0);
        dVgsteff_dVd = vec8_blend(dVgsteff_dVd, -dVth_dVd, condmask_true0);
        dVgsteff_dVb = vec8_blend(dVgsteff_dVb, -dVth_dVb, condmask_true0);
      }
      if (1)
      {
        Vec8m condmask1 = VgstNVt < ((float) (-EXP_THRESHOLD));
        Vec8m condmask_true1 = condmask_false0 & condmask1;
        Vec8m condmask_false1 = condmask_false0 & (~condmask1);
        {
          Vgsteff = vec8_blend(Vgsteff, T0 * ((float) log(1.0 + MIN_EXP)), condmask_true1);
        ...
        }
        {
          ...
          Vgsteff = vec8_blend(Vgsteff, T0 * vec8_log(((float) 1.0) + ExpVgst), condmask_false1);
          dVgsteff_dVg = vec8_blend(dVgsteff_dVg, ExpVgst / (((float) 1.0) + ExpVgst), condmask_false1);
          dVgsteff_dVd = vec8_blend(dVgsteff_dVd, ((-dVgsteff_dVg) * (dVth_dVd + (((Vgst - ((float) voffcv)) / noff) * dnoff_dVd))) + ((Vgsteff / noff) * dnoff_dVd), condmask_false1);
          dVgsteff_dVb = vec8_blend(dVgsteff_dVb, ((-dVgsteff_dVg) * (dVth_dVb + (((Vgst - ((float) voffcv)) / noff) * dnoff_dVb))) + ((Vgsteff / noff) * dnoff_dVb), condmask_false1);
    ...
    if (model->BSIM3v32capMod == 1)
    {
      switch (model->BSIM3v32intVersion)
      {
        ...
        default:
          Vfb = (Vth - ((float) pParam->BSIM3v32phi)) - (((float) pParam->BSIM3v32k1ox) * sqrtPhis);
          dVfb_dVb = dVth_dVb - (((float) pParam->BSIM3v32k1ox) * dsqrtPhis_dVb);
          dVfb_dVd = dVth_dVd;
      ...
      if (1)
      {
        ...
        {
          qgate = vec8_blend(qgate, ((float) CoxWL) * Arg1, condmask_true0);
          Cgg = vec8_blend(Cgg, ((float) CoxWL) * (dVgs_eff_dVg - dVgsteff_dVg), condmask_true0);
          switch (model->BSIM3v32intVersion)
          {
            case BSIM3v32V324:
            ...
            case BSIM3v32V322:
              Cgd = vec8_blend(Cgd, ((float) (-CoxWL)) * dVgsteff_dVd, condmask_true0);
              Cgb = vec8_blend(Cgb, ((float) (-CoxWL)) * (dVbseffCV_dVb + dVgsteff_dVb), condmask_true0);
              break;

            case BSIM3v32V32:

            default:
              Cgd = vec8_blend(Cgd, ((float) (-CoxWL)) * (dVfb_dVd + dVgsteff_dVd), condmask_true0);
              Cgb = vec8_blend(Cgb, ((float) (-CoxWL)) * ((dVfb_dVb + dVbseffCV_dVb) + dVgsteff_dVb), condmask_true0);
        ...
        }
        {
          ...
          T2 = vec8_blend(T2, (((float) CoxWL) * T0) / T1, condmask_false0);
          qgate = vec8_blend(qgate, ((float) (CoxWL * pParam->BSIM3v32k1ox)) * (T1 - T0), condmask_false0);
      ...
      One_Third_CoxWL = CoxWL / 3.0;
      Two_Third_CoxWL = 2.0 * One_Third_CoxWL;
      AbulkCV = Abulk0 * ((float) pParam->BSIM3v32abulkCVfactor);
      dAbulkCV_dVb = ((float) pParam->BSIM3v32abulkCVfactor) * dAbulk0_dVb;
      ...
      if (1)
      {
        ...
        Vec8m condmask_false0 = ~condmask0;
        {
          dVdsatCV_dVg = vec8_blend(dVdsatCV_dVg, ((float) 1.0) / AbulkCV, condmask_true0);
          dVdsatCV_dVb = vec8_blend(dVdsatCV_dVb, ((-VdsatCV) * dAbulkCV_dVb) / AbulkCV, condmask_true0);
          T0 = vec8_blend(T0, Vgsteff - (VdsatCV / ((float) 3.0)), condmask_true0);
          dT0_dVg = vec8_blend(dT0_dVg, ((float) 1.0) - (dVdsatCV_dVg / ((float) 3.0)), condmask_true0);
          dT0_dVb = vec8_blend(dT0_dVb, (-dVdsatCV_dVb) / ((float) 3.0), condmask_true0);
          qgate = vec8_blend(qgate, qgate + (((float) CoxWL) * T0), condmask_true0);
          Cgg1 = vec8_blend(Cgg1, ((float) CoxWL) * dT0_dVg, condmask_true0);
          Cgb1 = vec8_blend(Cgb1, (((float) CoxWL) * dT0_dVb) + (Cgg1 * dVgsteff_dVb), condmask_true0);
          ...
          dT0_dVg = vec8_blend(dT0_dVg, dVdsatCV_dVg - ((float) 1.0), condmask_true0);
          dT0_dVb = vec8_blend(dT0_dVb, dVdsatCV_dVb, condmask_true0);
          qbulk = vec8_blend(qbulk, qbulk + (((float) One_Third_CoxWL) * T0), condmask_true0);
          Cbg1 = vec8_blend(Cbg1, ((float) One_Third_CoxWL) * dT0_dVg, condmask_true0);
          Cbb1 = vec8_blend(Cbb1, (((float) One_Third_CoxWL) * dT0_dVb) + (Cbg1 * dVgsteff_dVb), condmask_true0);
        ...
        }
        {
          ...
          T1 = vec8_blend(T1, ((float) 12.0) * ((Vgsteff - (((float) 0.5) * T0)) + ((float) 1.e-20)), condmask_false0);
          T2 = vec8_blend(T2, Vds / T1, condmask_false0);
          T3 = vec8_blend(T3, T0 * T2, condmask_false0);
          dT3_dVg = vec8_blend(dT3_dVg, ((((float) (-12.0)) * T2) * T2) * AbulkCV, condmask_false0);
          dT3_dVd = vec8_blend(dT3_dVd, ((((((float) 6.0) * T0) * ((((float) 4.0) * Vgsteff) - T0)) / T1) / T1) - ((float) 0.5), condmask_false0);
          dT3_dVb = vec8_blend(dT3_dVb, (((((float) 12.0) * T2) * T2) * dAbulkCV_dVb) * Vgsteff, condmask_false0);
          qgate = vec8_blend(qgate, qgate + (((float) CoxWL) * ((Vgsteff - (((float) 0.5) * Vds)) + T3)), condmask_false0);
          Cgg1 = vec8_blend(Cgg1, ((float) CoxWL) * (((float) 1.0) + dT3_dVg), condmask_false0);
          Cgb1 = vec8_blend(Cgb1, (((float) CoxWL) * dT3_dVb) + (Cgg1 * dVgsteff_dVb), condmask_false0);
          Cgd1 = vec8_blend(Cgd1, (((float) CoxWL) * dT3_dVd) + (Cgg1 * dVgsteff_dVd), condmask_false0);
          ...
          qbulk = vec8_blend(qbulk, qbulk + ((((float) CoxWL) * (((float) 1.0) - AbulkCV)) * ((((float) 0.5) * Vds) - T3)), condmask_false0);
          Cbg1 = vec8_blend(Cbg1, ((float) (-CoxWL)) * ((((float) 1.0) - AbulkCV) * dT3_dVg), condmask_false0);
          Cbb1 = vec8_blend(Cbb1, (((float) (-CoxWL)) * (((((float) 1.0) - AbulkCV) * dT3_dVb) + (((((float) 0.5) * Vds) - T3) * dAbulkCV_dVb))) + (Cbg1 * dVgsteff_dVb), condmask_false0);
          Cbd1 = vec8_blend(Cbd1, ((((float) (-CoxWL)) * (((float) 1.0) - AbulkCV)) * dT3_dVd) + (Cbg1 * dVgsteff_dVd), condmask_false0);
          ...
          {
            T1 = vec8_blend(T1, T1 + T1, condmask_false0);
            qsrc = vec8_blend(qsrc, ((float) (-CoxWL)) * (((((float) 0.5) * Vgsteff) + (((float) 0.25) * T0)) - ((T0 * T0) / T1)), condmask_false0);
            Csg = vec8_blend(Csg, ((float) (-CoxWL)) * (((float) 0.5) + (((((((float) 24.0) * T0) * Vds) / T1) / T1) * AbulkCV)), condmask_false0);
            Csb = vec8_blend(Csb, (((float) (-CoxWL)) * (((((float) 0.25) * Vds) * dAbulkCV_dVb) - ((((((((float) 12.0) * T0) * Vds) / T1) / T1) * ((((float) 4.0) * Vgsteff) - T0)) * dAbulkCV_dVb))) + (Csg * dVgsteff_dVb), condmask_false0);
            Csd = vec8_blend(Csd, (((float) (-CoxWL)) * ((((float) 0.25) * AbulkCV) - (((((((float) 12.0) * AbulkCV) * T0) / T1) / T1) * ((((float) 4.0) * Vgsteff) - T0)))) + (Csg * dVgsteff_dVd), condmask_false0);
            Csg = vec8_blend(Csg, Csg * dVgsteff_dVg, condmask_false0);
          }
          else
            if (model->BSIM3v32xpart < 0.5)
          {
            T1 = vec8_blend(T1, T1 / ((float) 12.0), condmask_false0);
            T2 = vec8_blend(T2, ((float) (0.5 * CoxWL)) / (T1 * T1), condmask_false0);
            T3 = vec8_blend(T3, (Vgsteff * ((((((float) 2.0) * T0) * T0) / ((float) 3.0)) + (Vgsteff * (Vgsteff - ((((float) 4.0) * T0) / ((float) 3.0)))))) - ((((((float) 2.0) * T0) * T0) * T0) / ((float) 15.0)), condmask_false0);
            qsrc = vec8_blend(qsrc, (-T2) * T3, condmask_false0);
            T4 = vec8_blend(T4, ((((float) (4.0 / 3.0)) * Vgsteff) * (Vgsteff - T0)) + ((((float) 0.4) * T0) * T0), condmask_false0);
            Csg = vec8_blend(Csg, ((((float) (-2.0)) * qsrc) / T1) - (T2 * ((Vgsteff * ((((float) 3.0) * Vgsteff) - ((((float) 8.0) * T0) / ((float) 3.0)))) + (((((float) 2.0) * T0) * T0) / ((float) 3.0)))), condmask_false0);
          ...
          {
            qsrc = vec8_blend(qsrc, ((float) (-0.5)) * (qgate + qbulk), condmask_false0);
            Csg = vec8_blend(Csg, ((float) (-0.5)) * (Cgg1 + Cbg1), condmask_false0);
            Csb = vec8_blend(Csb, ((float) (-0.5)) * (Cgb1 + Cbb1), condmask_false0);
            Csd = vec8_blend(Csd, ((float) (-0.5)) * (Cgd1 + Cbd1), condmask_false0);
          }
      ...
      if (model->BSIM3v32capMod == 2)
    {
      ...
      V3 = ((Vfb - Vgs_eff) + VbseffCV) - ((float) DELTA_3);
      T0 = V3 * V3;
      T2 = ((float) (4.0 * DELTA_3)) * Vfb;
      if (1)
      {
        Vec8m condmask0 = Vfb <= ((float) 0.0);
        Vec8m condmask_true0 = condmask0;
        Vec8m condmask_false0 = ~condmask0;
        {
      ...
      T0 = vec8_sqrt(T0);
      T2 = T2 / T0;
      T1 = ((float) 0.5) * (((float) 1.0) + (V3 / T0));
      Vfbeff = Vfb - (((float) 0.5) * (V3 + T0));
      switch (model->BSIM3v32intVersion)
      {
        case BSIM3v32V324:
        ...
        default:
          dVfbeff_dVd = ((((float) 1.0) - T1) - T2) * dVfb_dVd;
      ...
      switch (model->BSIM3v32intVersion)
      {
        ...
        default:
          dVfbeff_dVb = (((((float) 1.0) - T1) - T2) * dVfb_dVb) - (T1 * dVbseffCV_dVb);

      }

      Qac0 = ((float) CoxWL) * (Vfbeff - Vfb);
      dQac0_dVg = ((float) CoxWL) * dVfbeff_dVg;
      switch (model->BSIM3v32intVersion)
      {
        case BSIM3v32V324:
        ...
        default:
          dQac0_dVd = ((float) CoxWL) * (dVfbeff_dVd - dVfb_dVd);
      ...
      switch (model->BSIM3v32intVersion)
      {
        ...
        case BSIM3v32V322:
          dQac0_dVb = ((float) CoxWL) * dVfbeff_dVb;
          break;

        case BSIM3v32V32:

        default:
          dQac0_dVb = ((float) CoxWL) * (dVfbeff_dVb - dVfb_dVb);
      ...
      if (pParam->BSIM3v32k1ox == 0.0)
      {
        ...
        if (1)
      {
        Vec8m condmask0 = T3 < ((float) 0.0);
        Vec8m condmask_true0 = condmask0;
        Vec8m condmask_false0 = ~condmask0;
        {
          T1 = vec8_blend(T1, T0 + (T3 / ((float) pParam->BSIM3v32k1ox)), condmask_true0);
      ...
      Qsub0 = ((float) (CoxWL * pParam->BSIM3v32k1ox)) * (T1 - T0);
      ...
      dAbulkCV_dVb = ((float) pParam->BSIM3v32abulkCVfactor) * dAbulk0_dVb;
      VdsatCV = Vgsteff / AbulkCV;
      V4 = (VdsatCV - Vds) - ((float) DELTA_4);
      T0 = vec8_sqrt((V4 * V4) + (((float) (4.0 * DELTA_4)) * VdsatCV));
      VdseffCV = VdsatCV - (((float) 0.5) * (V4 + T0));
      T1 = ((float) 0.5) * (((float) 1.0) + (V4 / T0));
      T2 = ((float) DELTA_4) / T0;
      T3 = ((((float) 1.0) - T1) - T2) / AbulkCV;
      dVdseffCV_dVg = T3;
      dVdseffCV_dVd = T1;
      ...
      T0 = AbulkCV * VdseffCV;
      T1 = ((float) 12.0) * ((Vgsteff - (((float) 0.5) * T0)) + ((float) 1e-20));
      T2 = VdseffCV / T1;
      T3 = T0 * T2;
      T4 = ((float) 1.0) - (((((float) 12.0) * T2) * T2) * AbulkCV);
      T5 = (((((float) 6.0) * T0) * ((((float) 4.0) * Vgsteff) - T0)) / (T1 * T1)) - ((float) 0.5);
      T6 = ((((float) 12.0) * T2) * T2) * Vgsteff;
      qinoi = ((float) (-CoxWL)) * ((Vgsteff - (((float) 0.5) * T0)) + (AbulkCV * T3));
      qgate = ((float) CoxWL) * ((Vgsteff - (((float) 0.5) * VdseffCV)) + T3);
      Cgg1 = ((float) CoxWL) * (T4 + (T5 * dVdseffCV_dVg));
      Cgd1 = ((((float) CoxWL) * T5) * dVdseffCV_dVd) + (Cgg1 * dVgsteff_dVd);
      Cgb1 = (((float) CoxWL) * ((T5 * dVdseffCV_dVb) + (T6 * dAbulkCV_dVb))) + (Cgg1 * dVgsteff_dVb);
      Cgg1 *= dVgsteff_dVg;
      T7 = ((float) 1.0) - AbulkCV;
      qbulk = (((float) CoxWL) * T7) * ((((float) 0.5) * VdseffCV) - T3);
      T4 = (-T7) * (T4 - ((float) 1.0));
      T5 = (-T7) * T5;
      T6 = -((T7 * T6) + ((((float) 0.5) * VdseffCV) - T3));
      Cbg1 = ((float) CoxWL) * (T4 + (T5 * dVdseffCV_dVg));
      Cbd1 = ((((float) CoxWL) * T5) * dVdseffCV_dVd) + (Cbg1 * dVgsteff_dVd);
      Cbb1 = (((float) CoxWL) * ((T5 * dVdseffCV_dVb) + (T6 * dAbulkCV_dVb))) + (Cbg1 * dVgsteff_dVb);
      Cbg1 *= dVgsteff_dVg;
      if (model->BSIM3v32xpart > 0.5)
      {
        T1 = T1 + T1;
        qsrc = ((float) (-CoxWL)) * (((((float) 0.5) * Vgsteff) + (((float) 0.25) * T0)) - ((T0 * T0) / T1));
        T7 = ((((float) 4.0) * Vgsteff) - T0) / (T1 * T1);
        T4 = -(((float) 0.5) + (((((float) 24.0) * T0) * T0) / (T1 * T1)));
        T5 = -((((float) 0.25) * AbulkCV) - (((((float) 12.0) * AbulkCV) * T0) * T7));
        T6 = -((((float) 0.25) * VdseffCV) - (((((float) 12.0) * T0) * VdseffCV) * T7));
        Csg = ((float) CoxWL) * (T4 + (T5 * dVdseffCV_dVg));
        Csd = ((((float) CoxWL) * T5) * dVdseffCV_dVd) + (Csg * dVgsteff_dVd);
        Csb = (((float) CoxWL) * ((T5 * dVdseffCV_dVb) + (T6 * dAbulkCV_dVb))) + (Csg * dVgsteff_dVb);
        Csg *= dVgsteff_dVg;
      }
      else
        if (model->BSIM3v32xpart < 0.5)
      {
        T1 = T1 / ((float) 12.0);
        T2 = ((float) (0.5 * CoxWL)) / (T1 * T1);
        T3 = (Vgsteff * ((((((float) 2.0) * T0) * T0) / ((float) 3.0)) + (Vgsteff * (Vgsteff - ((((float) 4.0) * T0) / ((float) 3.0)))))) - ((((((float) 2.0) * T0) * T0) * T0) / ((float) 15.0));
        qsrc = (-T2) * T3;
        T7 = ((((float) (4.0 / 3.0)) * Vgsteff) * (Vgsteff - T0)) + ((((float) 0.4) * T0) * T0);
        T4 = ((((float) (-2.0)) * qsrc) / T1) - (T2 * ((Vgsteff * ((((float) 3.0) * Vgsteff) - ((((float) 8.0) * T0) / ((float) 3.0)))) + (((((float) 2.0) * T0) * T0) / ((float) 3.0))));
      ...
      {
        qsrc = ((float) (-0.5)) * (qgate + qbulk);
        Csg = ((float) (-0.5)) * (Cgg1 + Cbg1);
        Csb = ((float) (-0.5)) * (Cgb1 + Cbb1);
        Csd = ((float) (-0.5)) * (Cgd1 + Cbd1);
      }
    ...
    {
      V3 = ((((Vec8d ){heres[0]->BSIM3v32vfbzb, heres[1]->BSIM3v32vfbzb, heres[2]->BSIM3v32vfbzb, heres[3]->BSIM3v32vfbzb, heres[4]->BSIM3v32vfbzb, heres[5]->BSIM3v32vfbzb, heres[6]->BSIM3v32vfbzb, heres[7]->BSIM3v32vfbzb}) - Vgs_eff) + VbseffCV) - ((float) DELTA_3);
      T0 = V3 * V3;
      T2 = ((float) (4.0 * DELTA_3)) * ((Vec8d ){heres[0]->BSIM3v32vfbzb, heres[1]->BSIM3v32vfbzb, heres[2]->BSIM3v32vfbzb, heres[3]->BSIM3v32vfbzb, heres[4]->BSIM3v32vfbzb, heres[5]->BSIM3v32vfbzb, heres[6]->BSIM3v32vfbzb, heres[7]->BSIM3v32vfbzb});
      if (1)
      {
        Vec8m condmask0 = ((Vec8d ){heres[0]->BSIM3v32vfbzb, heres[1]->BSIM3v32vfbzb, heres[2]->BSIM3v32vfbzb, heres[3]->BSIM3v32vfbzb, heres[4]->BSIM3v32vfbzb, heres[5]->BSIM3v32vfbzb, heres[6]->BSIM3v32vfbzb, heres[7]->BSIM3v32vfbzb}) <= ((float) 0.0);
        Vec8m condmask_true0 = condmask0;
        Vec8m condmask_false0 = ~condmask0;
        {
          T0 = vec8_blend(T0, T0 - T2, condmask_true0);
      ...
      T2 = T2 / T0;
      T1 = ((float) 0.5) * (((float) 1.0) + (V3 / T0));
      Vfbeff = ((Vec8d ){heres[0]->BSIM3v32vfbzb, heres[1]->BSIM3v32vfbzb, heres[2]->BSIM3v32vfbzb, heres[3]->BSIM3v32vfbzb, heres[4]->BSIM3v32vfbzb, heres[5]->BSIM3v32vfbzb, heres[6]->BSIM3v32vfbzb, heres[7]->BSIM3v32vfbzb}) - (((float) 0.5) * (V3 + T0));
      dVfbeff_dVg = T1 * dVgs_eff_dVg;
      dVfbeff_dVb = (-T1) * dVbseffCV_dVb;
      Cox = model->BSIM3v32cox;
      Tox = 1.0e8 * model->BSIM3v32tox;
      T0 = ((Vgs_eff - VbseffCV) - ((Vec8d ){heres[0]->BSIM3v32vfbzb, heres[1]->BSIM3v32vfbzb, heres[2]->BSIM3v32vfbzb, heres[3]->BSIM3v32vfbzb, heres[4]->BSIM3v32vfbzb, heres[5]->BSIM3v32vfbzb, heres[6]->BSIM3v32vfbzb, heres[7]->BSIM3v32vfbzb})) / ((float) Tox);
      dT0_dVg = dVgs_eff_dVg / ((float) Tox);
      dT0_dVb = (-dVbseffCV_dVb) / ((float) Tox);
      tmp = T0 * ((float) pParam->BSIM3v32acde);
      dTcen_dVg = (dTcen_dVb = vec8_SIMDTOVECTOR(0.0));
      if (1)
      {
        Vec8m condmask0 = (((float) (-EXP_THRESHOLD)) < tmp) & (tmp < ((float) EXP_THRESHOLD));
        Vec8m condmask_true0 = condmask0;
        Vec8m condmask_false0 = ~condmask0;
        {
          Tcen = vec8_blend(Tcen, ((float) pParam->BSIM3v32ldeb) * vec8_exp(tmp), condmask_true0);
          dTcen_dVg = vec8_blend(dTcen_dVg, ((float) pParam->BSIM3v32acde) * Tcen, condmask_true0);
        ...
        if (1)
        {
          Vec8m condmask1 = tmp <= ((float) (-EXP_THRESHOLD));
          Vec8m condmask_true1 = condmask_false0 & condmask1;
          Vec8m condmask_false1 = condmask_false0 & (~condmask1);
          {
      ...
      V3 = (((float) pParam->BSIM3v32ldeb) - Tcen) - ((float) LINK);
      V4 = vec8_sqrt((V3 * V3) + ((float) ((4.0 * LINK) * pParam->BSIM3v32ldeb)));
      Tcen = ((float) pParam->BSIM3v32ldeb) - (((float) 0.5) * (V3 + V4));
      T1 = ((float) 0.5) * (((float) 1.0) + (V3 / V4));
      dTcen_dVg *= T1;
      dTcen_dVb *= T1;
      Ccen = ((float) EPSSI) / Tcen;
      T2 = ((float) Cox) / (((float) Cox) + Ccen);
      Coxeff = T2 * Ccen;
      T3 = (-Ccen) / Tcen;
      dCoxeff_dVg = (T2 * T2) * T3;
      dCoxeff_dVb = dCoxeff_dVg * dTcen_dVb;
      dCoxeff_dVg *= dTcen_dVg;
      CoxWLcen = (((float) CoxWL) * Coxeff) / ((float) Cox);
      ...
      Qsub0 = (CoxWLcen * ((float) pParam->BSIM3v32k1ox)) * (T1 - T0);
      QovCox = Qsub0 / Coxeff;
      ...
      T1 = (((float) 2.0) * T0) + Vgsteff;
      DeltaPhi = ((float) Vtm) * vec8_log(((float) 1.0) + ((T1 * Vgsteff) / Denomi));
      dDeltaPhi_dVg = (((float) (2.0 * Vtm)) * (T1 - T0)) / (Denomi + (T1 * Vgsteff));
      dDeltaPhi_dVd = dDeltaPhi_dVg * dVgsteff_dVd;
      dDeltaPhi_dVb = dDeltaPhi_dVg * dVgsteff_dVb;
      T3 = ((float) 4.0) * ((Vth - ((Vec8d ){heres[0]->BSIM3v32vfbzb, heres[1]->BSIM3v32vfbzb, heres[2]->BSIM3v32vfbzb, heres[3]->BSIM3v32vfbzb, heres[4]->BSIM3v32vfbzb, heres[5]->BSIM3v32vfbzb, heres[6]->BSIM3v32vfbzb, heres[7]->BSIM3v32vfbzb})) - ((float) pParam->BSIM3v32phi));
      Tox += Tox;
      if (1)
      {
        Vec8m condmask0 = T3 >= ((float) 0.0);
        ...
        Vec8m condmask_false0 = ~condmask0;
        {
          switch (model->BSIM3v32intVersion)
          {
            ...
            case BSIM3v32V322:
              T0 = vec8_blend(T0, (Vgsteff + T3) / ((float) Tox), condmask_true0);
              dT0_dVd = vec8_blend(dT0_dVd, (dVgsteff_dVd + (((float) 4.0) * dVth_dVd)) / ((float) Tox), condmask_true0);
              dT0_dVb = vec8_blend(dT0_dVb, (dVgsteff_dVb + (((float) 4.0) * dVth_dVb)) / ((float) Tox), condmask_true0);
              break;
        ...
        }
        {
          switch (model->BSIM3v32intVersion)
          {
            ...
            case BSIM3v32V322:
              T0 = vec8_blend(T0, (Vgsteff + ((float) 1.0e-20)) / ((float) Tox), condmask_false0);
              dT0_dVd = vec8_blend(dT0_dVd, dVgsteff_dVd / ((float) Tox), condmask_false0);
              dT0_dVb = vec8_blend(dT0_dVb, dVgsteff_dVb / ((float) Tox), condmask_false0);
              break;
      ...
      T1 = ((float) 1.0) + tmp;
      T2 = (((float) 0.7) * tmp) / (T0 * ((float) Tox));
      Tcen = ((float) 1.9e-9) / T1;
      dTcen_dVg = ((((float) (-1.9e-9)) * T2) / T1) / T1;
      switch (model->BSIM3v32intVersion)
      {
        case BSIM3v32V324:
        ...
        default:
          dTcen_dVd = dTcen_dVg * ((((float) 4.0) * dVth_dVd) + dVgsteff_dVd);
          dTcen_dVb = dTcen_dVg * ((((float) 4.0) * dVth_dVb) + dVgsteff_dVb);

      }

      dTcen_dVg *= dVgsteff_dVg;
      Ccen = ((float) EPSSI) / Tcen;
      T0 = ((float) Cox) / (((float) Cox) + Ccen);
      Coxeff = T0 * Ccen;
      T1 = (-Ccen) / Tcen;
      ...
      T0 = AbulkCV * VdseffCV;
      T1 = Vgsteff - DeltaPhi;
      T2 = ((float) 12.0) * ((T1 - (((float) 0.5) * T0)) + ((float) 1.0e-20));
      T3 = T0 / T2;
      T4 = ((float) 1.0) - ((((float) 12.0) * T3) * T3);
      T5 = AbulkCV * ((((((float) 6.0) * T0) * ((((float) 4.0) * T1) - T0)) / (T2 * T2)) - ((float) 0.5));
      T6 = (T5 * VdseffCV) / AbulkCV;
      qgate = (qinoi = CoxWLcen * (T1 - (T0 * (((float) 0.5) - T3))));
      QovCox = qgate / Coxeff;
      Cgg1 = CoxWLcen * ((T4 * (((float) 1.0) - dDeltaPhi_dVg)) + (T5 * dVdseffCV_dVg));
      ...
      T7 = ((float) 1.0) - AbulkCV;
      T8 = T2 * T2;
      T9 = (((((float) 12.0) * T7) * T0) * T0) / (T8 * AbulkCV);
      T10 = T9 * (((float) 1.0) - dDeltaPhi_dVg);
      T11 = ((-T7) * T5) / AbulkCV;
      T12 = -(((T9 * T1) / AbulkCV) + (VdseffCV * (((float) 0.5) - (T0 / T2))));
      qbulk = (CoxWLcen * T7) * ((((float) 0.5) * VdseffCV) - ((T0 * VdseffCV) / T2));
      QovCox = qbulk / Coxeff;
      ...
      if (model->BSIM3v32xpart > 0.5)
      {
        qsrc = (-CoxWLcen) * (((T1 / ((float) 2.0)) + (T0 / ((float) 4.0))) - (((((float) 0.5) * T0) * T0) / T2));
        QovCox = qsrc / Coxeff;
        T2 += T2;
        T3 = T2 * T2;
        T7 = -(((float) 0.25) - (((((float) 12.0) * T0) * ((((float) 4.0) * T1) - T0)) / T3));
        T4 = (-(((float) 0.5) + (((((float) 24.0) * T0) * T0) / T3))) * (((float) 1.0) - dDeltaPhi_dVg);
        T5 = T7 * AbulkCV;
        T6 = T7 * VdseffCV;
      ...
      {
        T2 = T2 / ((float) 12.0);
        T3 = (((float) 0.5) * CoxWLcen) / (T2 * T2);
        T4 = (T1 * ((((((float) 2.0) * T0) * T0) / ((float) 3.0)) + (T1 * (T1 - ((((float) 4.0) * T0) / ((float) 3.0)))))) - ((((((float) 2.0) * T0) * T0) * T0) / ((float) 15.0));
        qsrc = (-T3) * T4;
        QovCox = qsrc / Coxeff;
        T8 = ((((float) (4.0 / 3.0)) * T1) * (T1 - T0)) + ((((float) 0.4) * T0) * T0);
        T5 = ((((float) (-2.0)) * qsrc) / T2) - (T3 * ((T1 * ((((float) 3.0) * T1) - ((((float) 8.0) * T0) / ((float) 3.0)))) + (((((float) 2.0) * T0) * T0) / ((float) 3.0))));
        T6 = AbulkCV * ((qsrc / T2) + (T3 * T8));
        T7 = (T6 * VdseffCV) / AbulkCV;
        Csg = (T5 * (((float) 1.0) - dDeltaPhi_dVg)) + (T6 * dVdseffCV_dVg);
  ...
  if (ChargeComputationNeeded)
  {
    ...
    if (model->BSIM3v32acmMod == 0)
    {
      switch (model->BSIM3v32intVersion)
      {
        ...
        case BSIM3v32V323:
          czbd = ((float) model->BSIM3v32unitAreaTempJctCap) * ((Vec8d ){heres[0]->BSIM3v32drainArea, heres[1]->BSIM3v32drainArea, heres[2]->BSIM3v32drainArea, heres[3]->BSIM3v32drainArea, heres[4]->BSIM3v32drainArea, heres[5]->BSIM3v32drainArea, heres[6]->BSIM3v32drainArea, heres[7]->BSIM3v32drainArea});
          czbs = ((float) model->BSIM3v32unitAreaTempJctCap) * ((Vec8d ){heres[0]->BSIM3v32sourceArea, heres[1]->BSIM3v32sourceArea, heres[2]->BSIM3v32sourceArea, heres[3]->BSIM3v32sourceArea, heres[4]->BSIM3v32sourceArea, heres[5]->BSIM3v32sourceArea, heres[6]->BSIM3v32sourceArea, heres[7]->BSIM3v32sourceArea});
          break;
        ...
        default:
          czbd = ((float) model->BSIM3v32unitAreaJctCap) * ((Vec8d ){heres[0]->BSIM3v32drainArea, heres[1]->BSIM3v32drainArea, heres[2]->BSIM3v32drainArea, heres[3]->BSIM3v32drainArea, heres[4]->BSIM3v32drainArea, heres[5]->BSIM3v32drainArea, heres[6]->BSIM3v32drainArea, heres[7]->BSIM3v32drainArea});
          czbs = ((float) model->BSIM3v32unitAreaJctCap) * ((Vec8d ){heres[0]->BSIM3v32sourceArea, heres[1]->BSIM3v32sourceArea, heres[2]->BSIM3v32sourceArea, heres[3]->BSIM3v32sourceArea, heres[4]->BSIM3v32sourceArea, heres[5]->BSIM3v32sourceArea, heres[6]->BSIM3v32sourceArea, heres[7]->BSIM3v32sourceArea});

      }

      if (1)
      {
        Vec8m condmask0 = ((Vec8d ){heres[0]->BSIM3v32drainPerimeter, heres[1]->BSIM3v32drainPerimeter, heres[2]->BSIM3v32drainPerimeter, heres[3]->BSIM3v32drainPerimeter, heres[4]->BSIM3v32drainPerimeter, heres[5]->BSIM3v32drainPerimeter, heres[6]->BSIM3v32drainPerimeter, heres[7]->BSIM3v32drainPerimeter}) < ((float) pParam->BSIM3v32weff);
        Vec8m condmask_true0 = condmask0;
        Vec8m condmask_false0 = ~condmask0;
        {
          ...
          switch (model->BSIM3v32intVersion)
          {
            ...
            default:
              czbdswg = vec8_blend(czbdswg, ((float) model->BSIM3v32unitLengthGateSidewallJctCap) * ((Vec8d ){heres[0]->BSIM3v32drainPerimeter, heres[1]->BSIM3v32drainPerimeter, heres[2]->BSIM3v32drainPerimeter, heres[3]->BSIM3v32drainPerimeter, heres[4]->BSIM3v32drainPerimeter, heres[5]->BSIM3v32drainPerimeter, heres[6]->BSIM3v32drainPerimeter, heres[7]->BSIM3v32drainPerimeter}), condmask_true0);
        ...
        }
        {
          switch (model->BSIM3v32intVersion)
          {
            ...
            default:
              czbdsw = vec8_blend(czbdsw, ((float) model->BSIM3v32unitLengthSidewallJctCap) * (((Vec8d ){heres[0]->BSIM3v32drainPerimeter, heres[1]->BSIM3v32drainPerimeter, heres[2]->BSIM3v32drainPerimeter, heres[3]->BSIM3v32drainPerimeter, heres[4]->BSIM3v32drainPerimeter, heres[5]->BSIM3v32drainPerimeter, heres[6]->BSIM3v32drainPerimeter, heres[7]->BSIM3v32drainPerimeter}) - ((float) pParam->BSIM3v32weff)), condmask_false0);
      ...
      if (1)
      {
        Vec8m condmask0 = ((Vec8d ){heres[0]->BSIM3v32sourcePerimeter, heres[1]->BSIM3v32sourcePerimeter, heres[2]->BSIM3v32sourcePerimeter, heres[3]->BSIM3v32sourcePerimeter, heres[4]->BSIM3v32sourcePerimeter, heres[5]->BSIM3v32sourcePerimeter, heres[6]->BSIM3v32sourcePerimeter, heres[7]->BSIM3v32sourcePerimeter}) < ((float) pParam->BSIM3v32weff);
        Vec8m condmask_true0 = condmask0;
        Vec8m condmask_false0 = ~condmask0;
        {
          ...
          switch (model->BSIM3v32intVersion)
          {
            ...
            default:
              czbsswg = vec8_blend(czbsswg, ((float) model->BSIM3v32unitLengthGateSidewallJctCap) * ((Vec8d ){heres[0]->BSIM3v32sourcePerimeter, heres[1]->BSIM3v32sourcePerimeter, heres[2]->BSIM3v32sourcePerimeter, heres[3]->BSIM3v32sourcePerimeter, heres[4]->BSIM3v32sourcePerimeter, heres[5]->BSIM3v32sourcePerimeter, heres[6]->BSIM3v32sourcePerimeter, heres[7]->BSIM3v32sourcePerimeter}), condmask_true0);
    ...
    if (1)
    {
      ...
      if (1)
      {
        Vec8m condmask1 = vbs < ((float) 0.0);
        Vec8m condmask_true1 = condmask_false0 & condmask1;
        Vec8m condmask_false1 = condmask_false0 & (~condmask1);
        {
          if (1)
          {
            Vec8m condmask2 = czbs > ((float) 0.0);
            Vec8m condmask_true2 = condmask_true1 & condmask2;
            Vec8m condmask_false2 = condmask_true1 & (~condmask2);
            {
              arg = vec8_blend(arg, ((float) 1.0) - (vbs / ((float) model->BSIM3v32PhiB)), condmask_true2);
              if (MJ == 0.5)
                sarg = vec8_blend(sarg, ((float) 1.0) / vec8_sqrt(arg), condmask_true2);
              else
                sarg = vec8_blend(sarg, vec8_powMJ(arg, -MJ), condmask_true2);

              nstate_qbs = vec8_blend(nstate_qbs, ((((float) model->BSIM3v32PhiB) * czbs) * (((float) 1.0) - (arg * sarg))) / ((float) (1.0 - MJ)), condmask_true2);
              {
                Vec8d val = czbs * sarg;
                if (condmask_true2[0])
                  heres[0]->BSIM3v32capbs = val[0];
          ...
          if (1)
          {
            Vec8m condmask2 = czbssw > ((float) 0.0);
            Vec8m condmask_true2 = condmask_true1 & condmask2;
            {
              arg = vec8_blend(arg, ((float) 1.0) - (vbs / ((float) model->BSIM3v32PhiBSW)), condmask_true2);
              if (MJSW == 0.5)
                sarg = vec8_blend(sarg, ((float) 1.0) / vec8_sqrt(arg), condmask_true2);
              else
                sarg = vec8_blend(sarg, vec8_powMJSW(arg, -MJSW), condmask_true2);

              nstate_qbs = vec8_blend(nstate_qbs, nstate_qbs + (((((float) model->BSIM3v32PhiBSW) * czbssw) * (((float) 1.0) - (arg * sarg))) / ((float) (1.0 - MJSW))), condmask_true2);
              {
          ...
          if (1)
          {
            Vec8m condmask2 = czbsswg > ((float) 0.0);
            Vec8m condmask_true2 = condmask_true1 & condmask2;
            {
              arg = vec8_blend(arg, ((float) 1.0) - (vbs / ((float) model->BSIM3v32PhiBSWG)), condmask_true2);
              if (MJSWG == 0.5)
                sarg = vec8_blend(sarg, ((float) 1.0) / vec8_sqrt(arg), condmask_true2);
              else
                sarg = vec8_blend(sarg, vec8_powMJSWG(arg, -MJSWG), condmask_true2);

              nstate_qbs = vec8_blend(nstate_qbs, nstate_qbs + (((((float) model->BSIM3v32PhiBSWG) * czbsswg) * (((float) 1.0) - (arg * sarg))) / ((float) (1.0 - MJSWG))), condmask_true2);
              {
        ...
        }
        {
          ...
          T1 = vec8_blend(T1, vbs * ((((czbs * ((float) MJ)) / ((float) model->BSIM3v32PhiB)) + ((czbssw * ((float) MJSW)) / ((float) model->BSIM3v32PhiBSW))) + ((czbsswg * ((float) MJSWG)) / ((float) model->BSIM3v32PhiBSWG))), condmask_false1);
          nstate_qbs = vec8_blend(nstate_qbs, vbs * (T0 + (((float) 0.5) * T1)), condmask_false1);
          {
            Vec8d val = T0 + T1;
            if (condmask_false1[0])
              heres[0]->BSIM3v32capbs = val[0];
    ...
    if (1)
    {
      ...
      if (1)
      {
        Vec8m condmask1 = vbd < ((float) 0.0);
        Vec8m condmask_true1 = condmask_false0 & condmask1;
        Vec8m condmask_false1 = condmask_false0 & (~condmask1);
        {
          if (1)
          {
            Vec8m condmask2 = czbd > ((float) 0.0);
            Vec8m condmask_true2 = condmask_true1 & condmask2;
            Vec8m condmask_false2 = condmask_true1 & (~condmask2);
            {
              arg = vec8_blend(arg, ((float) 1.0) - (vbd / ((float) model->BSIM3v32PhiB)), condmask_true2);
              if (MJ == 0.5)
                sarg = vec8_blend(sarg, ((float) 1.0) / vec8_sqrt(arg), condmask_true2);
              else
                sarg = vec8_blend(sarg, vec8_powMJ(arg, -MJ), condmask_true2);

              nstate_qbd = vec8_blend(nstate_qbd, ((((float) model->BSIM3v32PhiB) * czbd) * (((float) 1.0) - (arg * sarg))) / ((float) (1.0 - MJ)), condmask_true2);
              {
                Vec8d val = czbd * sarg;
                if (condmask_true2[0])
                  heres[0]->BSIM3v32capbd = val[0];
          ...
          if (1)
          {
            Vec8m condmask2 = czbdsw > ((float) 0.0);
            Vec8m condmask_true2 = condmask_true1 & condmask2;
            {
              arg = vec8_blend(arg, ((float) 1.0) - (vbd / ((float) model->BSIM3v32PhiBSW)), condmask_true2);
              if (MJSW == 0.5)
                sarg = vec8_blend(sarg, ((float) 1.0) / vec8_sqrt(arg), condmask_true2);
              else
                sarg = vec8_blend(sarg, vec8_powMJSW(arg, -MJSW), condmask_true2);

              nstate_qbd = vec8_blend(nstate_qbd, nstate_qbd + (((((float) model->BSIM3v32PhiBSW) * czbdsw) * (((float) 1.0) - (arg * sarg))) / ((float) (1.0 - MJSW))), condmask_true2);
              {
          ...
          if (1)
          {
            Vec8m condmask2 = czbdswg > ((float) 0.0);
            Vec8m condmask_true2 = condmask_true1 & condmask2;
            {
              arg = vec8_blend(arg, ((float) 1.0) - (vbd / ((float) model->BSIM3v32PhiBSWG)), condmask_true2);
              if (MJSWG == 0.5)
                sarg = vec8_blend(sarg, ((float) 1.0) / vec8_sqrt(arg), condmask_true2);
              else
                sarg = vec8_blend(sarg, vec8_powMJSWG(arg, -MJSWG), condmask_true2);

              nstate_qbd = vec8_blend(nstate_qbd, nstate_qbd + (((((float) model->BSIM3v32PhiBSWG) * czbdswg) * (((float) 1.0) - (arg * sarg))) / ((float) (1.0 - MJSWG))), condmask_true2);
              {
        ...
        }
        {
          ...
          T1 = vec8_blend(T1, vbd * ((((czbd * ((float) MJ)) / ((float) model->BSIM3v32PhiB)) + ((czbdsw * ((float) MJSW)) / ((float) model->BSIM3v32PhiBSW))) + ((czbdswg * ((float) MJSWG)) / ((float) model->BSIM3v32PhiBSWG))), condmask_false1);
          nstate_qbd = vec8_blend(nstate_qbd, vbd * (T0 + (((float) 0.5) * T1)), condmask_false1);
          {
            Vec8d val = T0 + T1;
            if (condmask_false1[0])
              heres[0]->BSIM3v32capbd = val[0];
  ...
  if (heres[0]->BSIM3v32nqsMod)
  {
    ...
    gtau_drift = vec8_fabs(((Vec8d ){heres[0]->BSIM3v32tconst, heres[1]->BSIM3v32tconst, heres[2]->BSIM3v32tconst, heres[3]->BSIM3v32tconst, heres[4]->BSIM3v32tconst, heres[5]->BSIM3v32tconst, heres[6]->BSIM3v32tconst, heres[7]->BSIM3v32tconst}) * qcheq) * ((float) ScalingFactor);
    T0 = vec8_SIMDTOVECTOR(pParam->BSIM3v32leffCV * pParam->BSIM3v32leffCV);
    gtau_diff = (((((float) 16.0) * ((Vec8d ){heres[0]->BSIM3v32u0temp, heres[1]->BSIM3v32u0temp, heres[2]->BSIM3v32u0temp, heres[3]->BSIM3v32u0temp, heres[4]->BSIM3v32u0temp, heres[5]->BSIM3v32u0temp, heres[6]->BSIM3v32u0temp, heres[7]->BSIM3v32u0temp})) * ((float) model->BSIM3v32vtm)) / T0) * ((float) ScalingFactor);
    {
  ...
  if (model->BSIM3v32capMod == 0)
  {
    ...
    qgdo = ((float) pParam->BSIM3v32cgdo) * vgd;
    cgso = vec8_SIMDTOVECTOR(pParam->BSIM3v32cgso);
    qgso = ((float) pParam->BSIM3v32cgso) * vgs;
  }
  else
    if (model->BSIM3v32capMod == 1)
  {
    if (1)
    {
      Vec8m condmask0 = vgd < ((float) 0.0);
      Vec8m condmask_true0 = condmask0;
      Vec8m condmask_false0 = ~condmask0;
      {
        T1 = vec8_blend(T1, vec8_sqrt(((float) 1.0) - ((((float) 4.0) * vgd) / ((float) pParam->BSIM3v32ckappa))), condmask_true0);
        cgdo = vec8_blend(cgdo, ((float) pParam->BSIM3v32cgdo) + (((float) (pParam->BSIM3v32weffCV * pParam->BSIM3v32cgdl)) / T1), condmask_true0);
        qgdo = vec8_blend(qgdo, (((float) pParam->BSIM3v32cgdo) * vgd) - (((float) (((pParam->BSIM3v32weffCV * 0.5) * pParam->BSIM3v32cgdl) * pParam->BSIM3v32ckappa)) * (T1 - ((float) 1.0))), condmask_true0);
      }
      {
        cgdo = vec8_blend(cgdo, vec8_SIMDTOVECTOR(pParam->BSIM3v32cgdo + (pParam->BSIM3v32weffCV * pParam->BSIM3v32cgdl)), condmask_false0);
        qgdo = vec8_blend(qgdo, ((float) ((pParam->BSIM3v32weffCV * pParam->BSIM3v32cgdl) + pParam->BSIM3v32cgdo)) * vgd, condmask_false0);
      }
    }

    if (1)
    {
      Vec8m condmask0 = vgs < ((float) 0.0);
      Vec8m condmask_true0 = condmask0;
      Vec8m condmask_false0 = ~condmask0;
      {
        T1 = vec8_blend(T1, vec8_sqrt(((float) 1.0) - ((((float) 4.0) * vgs) / ((float) pParam->BSIM3v32ckappa))), condmask_true0);
        cgso = vec8_blend(cgso, ((float) pParam->BSIM3v32cgso) + (((float) (pParam->BSIM3v32weffCV * pParam->BSIM3v32cgsl)) / T1), condmask_true0);
        qgso = vec8_blend(qgso, (((float) pParam->BSIM3v32cgso) * vgs) - (((float) (((pParam->BSIM3v32weffCV * 0.5) * pParam->BSIM3v32cgsl) * pParam->BSIM3v32ckappa)) * (T1 - ((float) 1.0))), condmask_true0);
      }
      {
        cgso = vec8_blend(cgso, vec8_SIMDTOVECTOR(pParam->BSIM3v32cgso + (pParam->BSIM3v32weffCV * pParam->BSIM3v32cgsl)), condmask_false0);
        qgso = vec8_blend(qgso, ((float) ((pParam->BSIM3v32weffCV * pParam->BSIM3v32cgsl) + pParam->BSIM3v32cgso)) * vgs, condmask_false0);
      }
    }
  ...
  {
    T0 = vgd + ((float) DELTA_1);
    T1 = vec8_sqrt((T0 * T0) + ((float) (4.0 * DELTA_1)));
    T2 = ((float) 0.5) * (T0 - T1);
    T3 = vec8_SIMDTOVECTOR(pParam->BSIM3v32weffCV * pParam->BSIM3v32cgdl);
    T4 = vec8_sqrt(((float) 1.0) - ((((float) 4.0) * T2) / ((float) pParam->BSIM3v32ckappa)));
    cgdo = (((float) pParam->BSIM3v32cgdo) + T3) - ((T3 * (((float) 1.0) - (((float) 1.0) / T4))) * (((float) 0.5) - ((((float) 0.5) * T0) / T1)));
    qgdo = ((((float) pParam->BSIM3v32cgdo) + T3) * vgd) - (T3 * (T2 + (((float) (0.5 * pParam->BSIM3v32ckappa)) * (T4 - ((float) 1.0)))));
    T0 = vgs + ((float) DELTA_1);
    T1 = vec8_sqrt((T0 * T0) + ((float) (4.0 * DELTA_1)));
    T2 = ((float) 0.5) * (T0 - T1);
    T3 = vec8_SIMDTOVECTOR(pParam->BSIM3v32weffCV * pParam->BSIM3v32cgsl);
    T4 = vec8_sqrt(((float) 1.0) - ((((float) 4.0) * T2) / ((float) pParam->BSIM3v32ckappa)));
    cgso = (((float) pParam->BSIM3v32cgso) + T3) - ((T3 * (((float) 1.0) - (((float) 1.0) / T4))) * (((float) 0.5) - ((((float) 0.5) * T0) / T1)));
    qgso = ((((float) pParam->BSIM3v32cgso) + T3) * vgs) - (T3 * (T2 + (((float) (0.5 * pParam->BSIM3v32ckappa)) * (T4 - ((float) 1.0)))));
  }
  ...
  if (1)
  {
    ...
    Vec8m condmask_false0 = ~condmask0;
    {
      ...
      {
        gcggb = vec8_blend(gcggb, (((((Vec8d ){heres[0]->BSIM3v32cggb, heres[1]->BSIM3v32cggb, heres[2]->BSIM3v32cggb, heres[3]->BSIM3v32cggb, heres[4]->BSIM3v32cggb, heres[5]->BSIM3v32cggb, heres[6]->BSIM3v32cggb, heres[7]->BSIM3v32cggb}) + cgdo) + cgso) + ((float) pParam->BSIM3v32cgbo)) * ((float) ag0), condmask_true0);
        ...
        gcgsb = vec8_blend(gcgsb, (((Vec8d ){heres[0]->BSIM3v32cgsb, heres[1]->BSIM3v32cgsb, heres[2]->BSIM3v32cgsb, heres[3]->BSIM3v32cgsb, heres[4]->BSIM3v32cgsb, heres[5]->BSIM3v32cgsb, heres[6]->BSIM3v32cgsb, heres[7]->BSIM3v32cgsb}) - cgso) * ((float) ag0), condmask_true0);
        gcdgb = vec8_blend(gcdgb, (((Vec8d ){heres[0]->BSIM3v32cdgb, heres[1]->BSIM3v32cdgb, heres[2]->BSIM3v32cdgb, heres[3]->BSIM3v32cdgb, heres[4]->BSIM3v32cdgb, heres[5]->BSIM3v32cdgb, heres[6]->BSIM3v32cdgb, heres[7]->BSIM3v32cdgb}) - cgdo) * ((float) ag0), condmask_true0);
        ...
        gcbgb = vec8_blend(gcbgb, (((Vec8d ){heres[0]->BSIM3v32cbgb, heres[1]->BSIM3v32cbgb, heres[2]->BSIM3v32cbgb, heres[3]->BSIM3v32cbgb, heres[4]->BSIM3v32cbgb, heres[5]->BSIM3v32cbgb, heres[6]->BSIM3v32cbgb, heres[7]->BSIM3v32cbgb}) - ((float) pParam->BSIM3v32cgbo)) * ((float) ag0), condmask_true0);
        ...
        qgb = vec8_blend(qgb, ((float) pParam->BSIM3v32cgbo) * vgb, condmask_true0);
      ...
      else
      {
        if (1)
        {
          Vec8m condmask1 = qcheq > ((float) 0.0);
          Vec8m condmask_true1 = condmask_true0 & condmask1;
          Vec8m condmask_false1 = condmask_true0 & (~condmask1);
          T0 = vec8_blend(T0, (((Vec8d ){heres[0]->BSIM3v32tconst, heres[1]->BSIM3v32tconst, heres[2]->BSIM3v32tconst, heres[3]->BSIM3v32tconst, heres[4]->BSIM3v32tconst, heres[5]->BSIM3v32tconst, heres[6]->BSIM3v32tconst, heres[7]->BSIM3v32tconst}) * qdef) * ((float) ScalingFactor), condmask_true1);
          T0 = vec8_blend(T0, ((-((Vec8d ){heres[0]->BSIM3v32tconst, heres[1]->BSIM3v32tconst, heres[2]->BSIM3v32tconst, heres[3]->BSIM3v32tconst, heres[4]->BSIM3v32tconst, heres[5]->BSIM3v32tconst, heres[6]->BSIM3v32tconst, heres[7]->BSIM3v32tconst})) * qdef) * ((float) ScalingFactor), condmask_false1);
        }
        ...
        gcqgb = vec8_blend(gcqgb, ((Vec8d ){heres[0]->BSIM3v32cqgb, heres[1]->BSIM3v32cqgb, heres[2]->BSIM3v32cqgb, heres[3]->BSIM3v32cqgb, heres[4]->BSIM3v32cqgb, heres[5]->BSIM3v32cqgb, heres[6]->BSIM3v32cqgb, heres[7]->BSIM3v32cqgb}) * ((float) ag0), condmask_true0);
        gcqdb = vec8_blend(gcqdb, ((Vec8d ){heres[0]->BSIM3v32cqdb, heres[1]->BSIM3v32cqdb, heres[2]->BSIM3v32cqdb, heres[3]->BSIM3v32cqdb, heres[4]->BSIM3v32cqdb, heres[5]->BSIM3v32cqdb, heres[6]->BSIM3v32cqdb, heres[7]->BSIM3v32cqdb}) * ((float) ag0), condmask_true0);
        ...
        gcqbb = vec8_blend(gcqbb, ((Vec8d ){heres[0]->BSIM3v32cqbb, heres[1]->BSIM3v32cqbb, heres[2]->BSIM3v32cqbb, heres[3]->BSIM3v32cqbb, heres[4]->BSIM3v32cqbb, heres[5]->BSIM3v32cqbb, heres[6]->BSIM3v32cqbb, heres[7]->BSIM3v32cqbb}) * ((float) ag0), condmask_true0);
        gcggb = vec8_blend(gcggb, ((cgdo + cgso) + ((float) pParam->BSIM3v32cgbo)) * ((float) ag0), condmask_true0);
        gcgdb = vec8_blend(gcgdb, (-cgdo) * ((float) ag0), condmask_true0);
        gcgsb = vec8_blend(gcgsb, (-cgso) * ((float) ag0), condmask_true0);
        gcdgb = vec8_blend(gcdgb, (-cgdo) * ((float) ag0), condmask_true0);
        gcddb = vec8_blend(gcddb, (((Vec8d ){heres[0]->BSIM3v32capbd, heres[1]->BSIM3v32capbd, heres[2]->BSIM3v32capbd, heres[3]->BSIM3v32capbd, heres[4]->BSIM3v32capbd, heres[5]->BSIM3v32capbd, heres[6]->BSIM3v32capbd, heres[7]->BSIM3v32capbd}) + cgdo) * ((float) ag0), condmask_true0);
        gcdsb = vec8_blend(gcdsb, vec8_SIMDTOVECTOR(0.0), condmask_true0);
        gcsgb = vec8_blend(gcsgb, (-cgso) * ((float) ag0), condmask_true0);
        gcsdb = vec8_blend(gcsdb, vec8_SIMDTOVECTOR(0.0), condmask_true0);
        gcssb = vec8_blend(gcssb, (((Vec8d ){heres[0]->BSIM3v32capbs, heres[1]->BSIM3v32capbs, heres[2]->BSIM3v32capbs, heres[3]->BSIM3v32capbs, heres[4]->BSIM3v32capbs, heres[5]->BSIM3v32capbs, heres[6]->BSIM3v32capbs, heres[7]->BSIM3v32capbs}) + cgso) * ((float) ag0), condmask_true0);
        gcbgb = vec8_blend(gcbgb, vec8_SIMDTOVECTOR((-pParam->BSIM3v32cgbo) * ag0), condmask_true0);
        gcbdb = vec8_blend(gcbdb, (-((Vec8d ){heres[0]->BSIM3v32capbd, heres[1]->BSIM3v32capbd, heres[2]->BSIM3v32capbd, heres[3]->BSIM3v32capbd, heres[4]->BSIM3v32capbd, heres[5]->BSIM3v32capbd, heres[6]->BSIM3v32capbd, heres[7]->BSIM3v32capbd})) * ((float) ag0), condmask_true0);
        gcbsb = vec8_blend(gcbsb, (-((Vec8d ){heres[0]->BSIM3v32capbs, heres[1]->BSIM3v32capbs, heres[2]->BSIM3v32capbs, heres[3]->BSIM3v32capbs, heres[4]->BSIM3v32capbs, heres[5]->BSIM3v32capbs, heres[6]->BSIM3v32capbs, heres[7]->BSIM3v32capbs})) * ((float) ag0), condmask_true0);
        if (1)
        {
          Vec8m condmask1 = vec8_fabs(qcheq) <= ((float) (1.0e-5 * CoxWL));
          Vec8m condmask_true1 = condmask_true0 & condmask1;
          Vec8m condmask_false1 = condmask_true0 & (~condmask1);
          {
            if (model->BSIM3v32xpart < 0.5)
        ...
        sxpart = vec8_blend(sxpart, ((float) 1.0) - dxpart, condmask_true0);
    ...
    }
    {
      if (heres[0]->BSIM3v32nqsMod == 0)
      {
        gcggb = vec8_blend(gcggb, (((((Vec8d ){heres[0]->BSIM3v32cggb, heres[1]->BSIM3v32cggb, heres[2]->BSIM3v32cggb, heres[3]->BSIM3v32cggb, heres[4]->BSIM3v32cggb, heres[5]->BSIM3v32cggb, heres[6]->BSIM3v32cggb, heres[7]->BSIM3v32cggb}) + cgdo) + cgso) + ((float) pParam->BSIM3v32cgbo)) * ((float) ag0), condmask_false0);
        gcgdb = vec8_blend(gcgdb, (((Vec8d ){heres[0]->BSIM3v32cgsb, heres[1]->BSIM3v32cgsb, heres[2]->BSIM3v32cgsb, heres[3]->BSIM3v32cgsb, heres[4]->BSIM3v32cgsb, heres[5]->BSIM3v32cgsb, heres[6]->BSIM3v32cgsb, heres[7]->BSIM3v32cgsb}) - cgdo) * ((float) ag0), condmask_false0);
        gcgsb = vec8_blend(gcgsb, (((Vec8d ){heres[0]->BSIM3v32cgdb, heres[1]->BSIM3v32cgdb, heres[2]->BSIM3v32cgdb, heres[3]->BSIM3v32cgdb, heres[4]->BSIM3v32cgdb, heres[5]->BSIM3v32cgdb, heres[6]->BSIM3v32cgdb, heres[7]->BSIM3v32cgdb}) - cgso) * ((float) ag0), condmask_false0);
        gcdgb = vec8_blend(gcdgb, (-(((((Vec8d ){heres[0]->BSIM3v32cggb, heres[1]->BSIM3v32cggb, heres[2]->BSIM3v32cggb, heres[3]->BSIM3v32cggb, heres[4]->BSIM3v32cggb, heres[5]->BSIM3v32cggb, heres[6]->BSIM3v32cggb, heres[7]->BSIM3v32cggb}) + ((Vec8d ){heres[0]->BSIM3v32cbgb, heres[1]->BSIM3v32cbgb, heres[2]->BSIM3v32cbgb, heres[3]->BSIM3v32cbgb, heres[4]->BSIM3v32cbgb, heres[5]->BSIM3v32cbgb, heres[6]->BSIM3v32cbgb, heres[7]->BSIM3v32cbgb})) + ((Vec8d ){heres[0]->BSIM3v32cdgb, heres[1]->BSIM3v32cdgb, heres[2]->BSIM3v32cdgb, heres[3]->BSIM3v32cdgb, heres[4]->BSIM3v32cdgb, heres[5]->BSIM3v32cdgb, heres[6]->BSIM3v32cdgb, heres[7]->BSIM3v32cdgb})) + cgdo)) * ((float) ag0), condmask_false0);
        gcddb = vec8_blend(gcddb, ((((Vec8d ){heres[0]->BSIM3v32capbd, heres[1]->BSIM3v32capbd, heres[2]->BSIM3v32capbd, heres[3]->BSIM3v32capbd, heres[4]->BSIM3v32capbd, heres[5]->BSIM3v32capbd, heres[6]->BSIM3v32capbd, heres[7]->BSIM3v32capbd}) + cgdo) - ((((Vec8d ){heres[0]->BSIM3v32cgsb, heres[1]->BSIM3v32cgsb, heres[2]->BSIM3v32cgsb, heres[3]->BSIM3v32cgsb, heres[4]->BSIM3v32cgsb, heres[5]->BSIM3v32cgsb, heres[6]->BSIM3v32cgsb, heres[7]->BSIM3v32cgsb}) + ((Vec8d ){heres[0]->BSIM3v32cbsb, heres[1]->BSIM3v32cbsb, heres[2]->BSIM3v32cbsb, heres[3]->BSIM3v32cbsb, heres[4]->BSIM3v32cbsb, heres[5]->BSIM3v32cbsb, heres[6]->BSIM3v32cbsb, heres[7]->BSIM3v32cbsb})) + ((Vec8d ){heres[0]->BSIM3v32cdsb, heres[1]->BSIM3v32cdsb, heres[2]->BSIM3v32cdsb, heres[3]->BSIM3v32cdsb, heres[4]->BSIM3v32cdsb, heres[5]->BSIM3v32cdsb, heres[6]->BSIM3v32cdsb, heres[7]->BSIM3v32cdsb}))) * ((float) ag0), condmask_false0);
        gcdsb = vec8_blend(gcdsb, (-((((Vec8d ){heres[0]->BSIM3v32cgdb, heres[1]->BSIM3v32cgdb, heres[2]->BSIM3v32cgdb, heres[3]->BSIM3v32cgdb, heres[4]->BSIM3v32cgdb, heres[5]->BSIM3v32cgdb, heres[6]->BSIM3v32cgdb, heres[7]->BSIM3v32cgdb}) + ((Vec8d ){heres[0]->BSIM3v32cbdb, heres[1]->BSIM3v32cbdb, heres[2]->BSIM3v32cbdb, heres[3]->BSIM3v32cbdb, heres[4]->BSIM3v32cbdb, heres[5]->BSIM3v32cbdb, heres[6]->BSIM3v32cbdb, heres[7]->BSIM3v32cbdb})) + ((Vec8d ){heres[0]->BSIM3v32cddb, heres[1]->BSIM3v32cddb, heres[2]->BSIM3v32cddb, heres[3]->BSIM3v32cddb, heres[4]->BSIM3v32cddb, heres[5]->BSIM3v32cddb, heres[6]->BSIM3v32cddb, heres[7]->BSIM3v32cddb}))) * ((float) ag0), condmask_false0);
        gcsgb = vec8_blend(gcsgb, (((Vec8d ){heres[0]->BSIM3v32cdgb, heres[1]->BSIM3v32cdgb, heres[2]->BSIM3v32cdgb, heres[3]->BSIM3v32cdgb, heres[4]->BSIM3v32cdgb, heres[5]->BSIM3v32cdgb, heres[6]->BSIM3v32cdgb, heres[7]->BSIM3v32cdgb}) - cgso) * ((float) ag0), condmask_false0);
        gcsdb = vec8_blend(gcsdb, ((Vec8d ){heres[0]->BSIM3v32cdsb, heres[1]->BSIM3v32cdsb, heres[2]->BSIM3v32cdsb, heres[3]->BSIM3v32cdsb, heres[4]->BSIM3v32cdsb, heres[5]->BSIM3v32cdsb, heres[6]->BSIM3v32cdsb, heres[7]->BSIM3v32cdsb}) * ((float) ag0), condmask_false0);
      ...
      else
      {
        ...
        gcqgb = vec8_blend(gcqgb, ((Vec8d ){heres[0]->BSIM3v32cqgb, heres[1]->BSIM3v32cqgb, heres[2]->BSIM3v32cqgb, heres[3]->BSIM3v32cqgb, heres[4]->BSIM3v32cqgb, heres[5]->BSIM3v32cqgb, heres[6]->BSIM3v32cqgb, heres[7]->BSIM3v32cqgb}) * ((float) ag0), condmask_false0);
        gcqdb = vec8_blend(gcqdb, ((Vec8d ){heres[0]->BSIM3v32cqsb, heres[1]->BSIM3v32cqsb, heres[2]->BSIM3v32cqsb, heres[3]->BSIM3v32cqsb, heres[4]->BSIM3v32cqsb, heres[5]->BSIM3v32cqsb, heres[6]->BSIM3v32cqsb, heres[7]->BSIM3v32cqsb}) * ((float) ag0), condmask_false0);
        gcqsb = vec8_blend(gcqsb, ((Vec8d ){heres[0]->BSIM3v32cqdb, heres[1]->BSIM3v32cqdb, heres[2]->BSIM3v32cqdb, heres[3]->BSIM3v32cqdb, heres[4]->BSIM3v32cqdb, heres[5]->BSIM3v32cqdb, heres[6]->BSIM3v32cqdb, heres[7]->BSIM3v32cqdb}) * ((float) ag0), condmask_false0);
        gcqbb = vec8_blend(gcqbb, ((Vec8d ){heres[0]->BSIM3v32cqbb, heres[1]->BSIM3v32cqbb, heres[2]->BSIM3v32cqbb, heres[3]->BSIM3v32cqbb, heres[4]->BSIM3v32cqbb, heres[5]->BSIM3v32cqbb, heres[6]->BSIM3v32cqbb, heres[7]->BSIM3v32cqbb}) * ((float) ag0), condmask_false0);
        gcggb = vec8_blend(gcggb, ((cgdo + cgso) + ((float) pParam->BSIM3v32cgbo)) * ((float) ag0), condmask_false0);
        gcgdb = vec8_blend(gcgdb, (-cgdo) * ((float) ag0), condmask_false0);
        gcgsb = vec8_blend(gcgsb, (-cgso) * ((float) ag0), condmask_false0);
        gcdgb = vec8_blend(gcdgb, (-cgdo) * ((float) ag0), condmask_false0);
        gcddb = vec8_blend(gcddb, (((Vec8d ){heres[0]->BSIM3v32capbd, heres[1]->BSIM3v32capbd, heres[2]->BSIM3v32capbd, heres[3]->BSIM3v32capbd, heres[4]->BSIM3v32capbd, heres[5]->BSIM3v32capbd, heres[6]->BSIM3v32capbd, heres[7]->BSIM3v32capbd}) + cgdo) * ((float) ag0), condmask_false0);
        gcdsb = vec8_blend(gcdsb, vec8_SIMDTOVECTOR(0.0), condmask_false0);
        gcsgb = vec8_blend(gcsgb, (-cgso) * ((float) ag0), condmask_false0);
        gcsdb = vec8_blend(gcsdb, vec8_SIMDTOVECTOR(0.0), condmask_false0);
        gcssb = vec8_blend(gcssb, (((Vec8d ){heres[0]->BSIM3v32capbs, heres[1]->BSIM3v32capbs, heres[2]->BSIM3v32capbs, heres[3]->BSIM3v32capbs, heres[4]->BSIM3v32capbs, heres[5]->BSIM3v32capbs, heres[6]->BSIM3v32capbs, heres[7]->BSIM3v32capbs}) + cgso) * ((float) ag0), condmask_false0);
        gcbgb = vec8_blend(gcbgb, vec8_SIMDTOVECTOR((-pParam->BSIM3v32cgbo) * ag0), condmask_false0);
        gcbdb = vec8_blend(gcbdb, (-((Vec8d ){heres[0]->BSIM3v32capbd, heres[1]->BSIM3v32capbd, heres[2]->BSIM3v32capbd, heres[3]->BSIM3v32capbd, heres[4]->BSIM3v32capbd, heres[5]->BSIM3v32capbd, heres[6]->BSIM3v32capbd, heres[7]->BSIM3v32capbd})) * ((float) ag0), condmask_false0);
        gcbsb = vec8_blend(gcbsb, (-((Vec8d ){heres[0]->BSIM3v32capbs, heres[1]->BSIM3v32capbs, heres[2]->BSIM3v32capbs, heres[3]->BSIM3v32capbs, heres[4]->BSIM3v32capbs, heres[5]->BSIM3v32capbs, heres[6]->BSIM3v32capbs, heres[7]->BSIM3v32capbs})) * ((float) ag0), condmask_false0);
        if (1)
        {
          Vec8m condmask1 = vec8_fabs(qcheq) <= ((float) (1.0e-5 * CoxWL));
          Vec8m condmask_true1 = condmask_false0 & condmask1;
        ...
        dxpart = vec8_blend(dxpart, ((float) 1.0) - sxpart, condmask_false0);
  ...
  if (heres[0]->BSIM3v32nqsMod)
  {
    vec8_BSIM3v32_StateStore(ckt->CKTstate0, (Vec8m ){heres[0]->BSIM3v32qcdump, heres[1]->BSIM3v32qcdump, heres[2]->BSIM3v32qcdump, heres[3]->BSIM3v32qcdump, heres[4]->BSIM3v32qcdump, heres[5]->BSIM3v32qcdump, heres[6]->BSIM3v32qcdump, heres[7]->BSIM3v32qcdump}, qdef * ((float) ScalingFactor));
  ...
  sxpart = ((float) 1.0) - dxpart;
  ddxpart_dVd = (ddxpart_dVg = (ddxpart_dVb = (ddxpart_dVs = vec8_SIMDTOVECTOR(0.0))));
  dsxpart_dVd = (dsxpart_dVg = (dsxpart_dVb = (dsxpart_dVs = vec8_SIMDTOVECTOR(0.0))));
  if (heres[0]->BSIM3v32nqsMod)
  {
    Vec8d val = ((((((float) 16.0) * ((Vec8d ){heres[0]->BSIM3v32u0temp, heres[1]->BSIM3v32u0temp, heres[2]->BSIM3v32u0temp, heres[3]->BSIM3v32u0temp, heres[4]->BSIM3v32u0temp, heres[5]->BSIM3v32u0temp, heres[6]->BSIM3v32u0temp, heres[7]->BSIM3v32u0temp})) * ((float) model->BSIM3v32vtm)) / ((float) pParam->BSIM3v32leffCV)) / ((float) pParam->BSIM3v32leffCV)) * ((float) ScalingFactor);
    heres[0]->BSIM3v32gtau = val[0];
    heres[1]->BSIM3v32gtau = val[1];
    heres[2]->BSIM3v32gtau = val[2];
    heres[3]->BSIM3v32gtau = val[3];
  ...
  if (1)
  {
    ...
    Vec8m condmask_false0 = ~condmask0;
    {
      ...
      cdreq = vec8_blend(cdreq, ((float) model->BSIM3v32type) * (((cdrain - (((Vec8d ){heres[0]->BSIM3v32gds, heres[1]->BSIM3v32gds, heres[2]->BSIM3v32gds, heres[3]->BSIM3v32gds, heres[4]->BSIM3v32gds, heres[5]->BSIM3v32gds, heres[6]->BSIM3v32gds, heres[7]->BSIM3v32gds}) * vds)) - (Gm * vgs)) - (Gmbs * vbs)), condmask_true0);
    ...
    }
    {
      ...
      cdreq = vec8_blend(cdreq, ((float) (-model->BSIM3v32type)) * (((cdrain + (((Vec8d ){heres[0]->BSIM3v32gds, heres[1]->BSIM3v32gds, heres[2]->BSIM3v32gds, heres[3]->BSIM3v32gds, heres[4]->BSIM3v32gds, heres[5]->BSIM3v32gds, heres[6]->BSIM3v32gds, heres[7]->BSIM3v32gds}) * vds)) + (Gm * vgd)) + (Gmbs * vbd)), condmask_false0);
      ceqbs = vec8_blend(ceqbs, ((float) (-model->BSIM3v32type)) * (((((Vec8d ){heres[0]->BSIM3v32csub, heres[1]->BSIM3v32csub, heres[2]->BSIM3v32csub, heres[3]->BSIM3v32csub, heres[4]->BSIM3v32csub, heres[5]->BSIM3v32csub, heres[6]->BSIM3v32csub, heres[7]->BSIM3v32csub}) + (((Vec8d ){heres[0]->BSIM3v32gbds, heres[1]->BSIM3v32gbds, heres[2]->BSIM3v32gbds, heres[3]->BSIM3v32gbds, heres[4]->BSIM3v32gbds, heres[5]->BSIM3v32gbds, heres[6]->BSIM3v32gbds, heres[7]->BSIM3v32gbds}) * vds)) - (((Vec8d ){heres[0]->BSIM3v32gbgs, heres[1]->BSIM3v32gbgs, heres[2]->BSIM3v32gbgs, heres[3]->BSIM3v32gbgs, heres[4]->BSIM3v32gbgs, heres[5]->BSIM3v32gbgs, heres[6]->BSIM3v32gbgs, heres[7]->BSIM3v32gbgs}) * vgd)) - (((Vec8d ){heres[0]->BSIM3v32gbbs, heres[1]->BSIM3v32gbbs, heres[2]->BSIM3v32gbbs, heres[3]->BSIM3v32gbbs, heres[4]->BSIM3v32gbbs, heres[5]->BSIM3v32gbbs, heres[6]->BSIM3v32gbbs, heres[7]->BSIM3v32gbbs}) * vbd)), condmask_false0);
