...
for( ; model != NULL; model = VDMOSnextModel(model)) {
  ...
  for (here = VDMOSinstances(model); here != NULL ;
	...
	/* x = vgs, y = vbs z = vds */
	    ...
	    r1h1y = *(job->r1H1ptr + (here->VDMOSbNode)) -
			*(job->r1H1ptr + (here->VDMOSsNodePrime));
	    i1h1y = *(job->i1H1ptr + (here->VDMOSbNode)) -
			*(job->i1H1ptr + (here->VDMOSsNodePrime));

	    r1h1z = *(job->r1H1ptr + (here->VDMOSdNodePrime)) -
			*(job->r1H1ptr + (here->VDMOSsNodePrime));
	    i1h1z = *(job->i1H1ptr + (here->VDMOSdNodePrime)) -
			*(job->i1H1ptr + (here->VDMOSsNodePrime));
	    ...
	    *(ckt->CKTrhs + (here->VDMOSbNode)) -= temp;
	    *(ckt->CKTirhs + (here->VDMOSbNode)) -= itemp;
	    *(ckt->CKTrhs + (here->VDMOSsNodePrime)) += temp;
	    *(ckt->CKTirhs + (here->VDMOSsNodePrime)) += itemp;
	...
	r2h11y = *(job->r2H11ptr + (here->VDMOSbNode)) -
		    *(job->r2H11ptr + (here->VDMOSsNodePrime));
	i2h11y = *(job->i2H11ptr + (here->VDMOSbNode)) -
		    *(job->i2H11ptr + (here->VDMOSsNodePrime));

	r2h11z = *(job->r2H11ptr + (here->VDMOSdNodePrime)) -
		    *(job->r2H11ptr + (here->VDMOSsNodePrime));
	i2h11z = *(job->i2H11ptr + (here->VDMOSdNodePrime)) -
		    *(job->i2H11ptr + (here->VDMOSsNodePrime));
		/* loading starts here */
		/* loading cdrain term  */
	...
	/* x = vgs, y = vbs z = vds */
	    ...
	    r1h2y = *(job->r1H2ptr + (here->VDMOSbNode)) -
			*(job->r1H2ptr + (here->VDMOSsNodePrime));
	    i1h2y = *(job->i1H2ptr + (here->VDMOSbNode)) -
			*(job->i1H2ptr + (here->VDMOSsNodePrime));

	    r1h2z = *(job->r1H2ptr + (here->VDMOSdNodePrime)) -
			*(job->r1H2ptr + (here->VDMOSsNodePrime));
	    i1h2z = *(job->i1H2ptr + (here->VDMOSdNodePrime)) -
			*(job->i1H2ptr + (here->VDMOSsNodePrime));
	...
	/* x = vgs, y = vbs z = vds */
	    ...
	    r1hm2y = *(job->r1H2ptr + (here->VDMOSbNode)) -
			*(job->r1H2ptr + (here->VDMOSsNodePrime));
	    i1hm2y = -(*(job->i1H2ptr + (here->VDMOSbNode)) -
			*(job->i1H2ptr + (here->VDMOSsNodePrime)));

	    r1hm2z = *(job->r1H2ptr + (here->VDMOSdNodePrime)) -
			*(job->r1H2ptr + (here->VDMOSsNodePrime));
	i1hm2z = -(*(job->i1H2ptr + (here->VDMOSdNodePrime)) -
			*(job->i1H2ptr + (here->VDMOSsNodePrime)));
	...
	i1hm2z = -(*(job->i1H2ptr + (here->VDMOSdNodePrime)) -
	    ...
	    r2h11y = *(job->r1H1ptr + (here->VDMOSbNode)) -
			*(job->r1H1ptr + (here->VDMOSsNodePrime));
	    i2h11y = *(job->i1H1ptr + (here->VDMOSbNode)) -
			*(job->i1H1ptr + (here->VDMOSsNodePrime));

	    r2h11z = *(job->r1H1ptr + (here->VDMOSdNodePrime)) -
			*(job->r1H1ptr + (here->VDMOSsNodePrime));
	    i2h11z = *(job->i1H1ptr + (here->VDMOSdNodePrime)) -
			*(job->i1H1ptr + (here->VDMOSsNodePrime));
    ...
    r2h1m2y = *(job->r2H1m2ptr + (here->VDMOSbNode)) -
		*(job->r2H1m2ptr + (here->VDMOSsNodePrime));
    i2h1m2y = *(job->i2H1m2ptr + (here->VDMOSbNode)) -
		*(job->i2H1m2ptr + (here->VDMOSsNodePrime));

r2h1m2z = *(job->r2H1m2ptr + (here->VDMOSdNodePrime)) -
		*(job->r2H1m2ptr + (here->VDMOSsNodePrime));
i2h1m2z = *(job->i2H1m2ptr + (here->VDMOSdNodePrime)) -
		*(job->i2H1m2ptr + (here->VDMOSsNodePrime));
