...
IFparm HICUMpTable[] = { /* parameters */
 ...
 IOPAU("icvb",  HICUM_IC_VB, IF_REAL,    "Initial B potential"),
 IOPAU("icvc",  HICUM_IC_VC, IF_REAL,    "Initial C potential"),
 IOPAU("icve",  HICUM_IC_VE, IF_REAL,    "Initial E potential"),
