...
int HICUMload(GENmodel *inModel, CKTcircuit *ckt)
{
    ...
    std::function<duals::duald(duals::duald, duals::duald)> calc_T_f0 = [&](duals::duald T, duals::duald Vbici) {
        ...
        if (here->HICUMcjci0_t.rpart > 0.0)
        { // CJMODF
    ...
    std::function<duals::duald(duals::duald, duals::duald, duals::duald)> calc_ibet = [&](duals::duald Vbiei, duals::duald Vbpei, duals::duald T) {
        //Tunneling current
        duals::duald ibet;
        if (here->HICUMibets_scaled > 0 && (Vbpei < 0.0 || Vbiei < 0.0))
        { //begin : HICTUN
    ...
    std::function<duals::duald(duals::duald, duals::duald, duals::duald, duals::duald, duals::duald, duals::duald)> calc_it = [&](duals::duald T, duals::duald Vbiei, duals::duald Vbici, duals::duald Q_0, duals::duald T_f0, duals::duald ick) {
        ...
        if (Qf > RTOLC * Q_p || a_h > RTOLC)
        {
            ...
            while (((abs(d_Q) >= RTOLC * abs(Q_pT)) && (l_it <= l_itmax)) || (extra_round < 5))
            {
                ...
                Q_pT = Q_pT + d_Q;
                l_it = l_it + 1;
                if (!(abs(d_Q) >= RTOLC * abs(Q_pT)))
                { //extra_rounds to get rid of derivative noise
    ...
    for (; model != NULL; model = HICUMnextModel(model))
    {
             ...
             here = HICUMnextInstance(here))
        {
            ...
            if (ckt->CKTmode & MODEINITSMSIG)
            {
                ...
                Vbci = model->HICUMtype * (*(ckt->CKTrhsOld + here->HICUMbaseNode) -
                                           *(ckt->CKTrhsOld + here->HICUMcollCINode));
                Vsici = *(ckt->CKTstate0 + here->HICUMvsici);
                Vsc = model->HICUMtype * (*(ckt->CKTrhsOld + here->HICUMsubsNode) -
                                          *(ckt->CKTrhsOld + here->HICUMcollNode));

                Vbpbi = *(ckt->CKTstate0 + here->HICUMvbpbi);
                Vbe = model->HICUMtype * (*(ckt->CKTrhsOld + here->HICUMbaseNode) -
                                          *(ckt->CKTrhsOld + here->HICUMemitNode));
                Vcic = model->HICUMtype * (*(ckt->CKTrhsOld + here->HICUMcollCINode) -
                                           *(ckt->CKTrhsOld + here->HICUMcollNode));
                Vbbp = model->HICUMtype * (*(ckt->CKTrhsOld + here->HICUMbaseNode) -
                                           *(ckt->CKTrhsOld + here->HICUMbaseBPNode));
                Vbpe = model->HICUMtype * (*(ckt->CKTrhsOld + here->HICUMbaseBPNode) -
                                           *(ckt->CKTrhsOld + here->HICUMemitNode));
                Veie = model->HICUMtype * (*(ckt->CKTrhsOld + here->HICUMemitEINode) -
                                           *(ckt->CKTrhsOld + here->HICUMemitNode));
                Vsis = model->HICUMtype * (*(ckt->CKTrhsOld + here->HICUMsubsSINode) -
            ...
            else
            {
                ...
                else
                {
                     ...
                     */
                    Vbiei = model->HICUMtype * (*(ckt->CKTrhsOld + here->HICUMbaseBINode) -
                                                *(ckt->CKTrhsOld + here->HICUMemitEINode));
                    Vbe = model->HICUMtype * (*(ckt->CKTrhsOld + here->HICUMbaseNode) -
                                              *(ckt->CKTrhsOld + here->HICUMemitNode));
                    Vbici = model->HICUMtype * (*(ckt->CKTrhsOld + here->HICUMbaseBINode) -
                                                *(ckt->CKTrhsOld + here->HICUMcollCINode));
                    Vbpei = model->HICUMtype * (*(ckt->CKTrhsOld + here->HICUMbaseBPNode) -
                                                *(ckt->CKTrhsOld + here->HICUMemitEINode));
                    Vbpbi = model->HICUMtype * (*(ckt->CKTrhsOld + here->HICUMbaseBPNode) -
                    ...
                    Vbbp = model->HICUMtype * (*(ckt->CKTrhsOld + here->HICUMbaseNode) -
                                               *(ckt->CKTrhsOld + here->HICUMbaseBPNode));
                    Vbpci = model->HICUMtype * (*(ckt->CKTrhsOld + here->HICUMbaseBPNode) -
                                                *(ckt->CKTrhsOld + here->HICUMcollCINode));
                    Vsici = model->HICUMtype * (*(ckt->CKTrhsOld + here->HICUMsubsSINode) -
                                                *(ckt->CKTrhsOld + here->HICUMcollCINode));
                    Vxf = *(ckt->CKTrhsOld + here->HICUMxfNode);
                    Vxf1 = *(ckt->CKTrhsOld + here->HICUMxf1Node);
                    Vxf2 = *(ckt->CKTrhsOld + here->HICUMxf2Node);
                ...
                if ((ichk1 == 1) || (ichk2 == 1) || (ichk3 == 1) || (ichk4 == 1) || (ichk5 == 1) || (ichk6 == 1))
                    icheck = 1;
            }
            /*
            ...
            if (!(Qf > RTOLC * Q_p || a_h > RTOLC))
            { // in this case the newton is not run and the derivatives of the initial solution are needed
                calc_it_initial(Temp_dual, Vbiei, Vbici, Q_0 + 1_e * Q_0_dT, T_f0 + 1_e * T_f0_dT, ick + 1_e * ick_dT, &result_itf, &result_itr, &result_Qf, &result_Qr, &result_Q_bf, &result_a_h, &result_Q_p, &result_Tf);
                itf_dT = result_itf.dpart();
                itr_dT = result_itr.dpart();
                Qf_dT = result_Qf.dpart();
            ...
            if (nqs)
            { // && (ckt->CKTmode & (MODETRAN | MODEAC) ) ) { //evaluate nqs network only in TRANSIENT and AC modes.
                ...
                (ckt->CKTmode & MODEINITSMSIG))
            {
                ...
                *(ckt->CKTstate0 + here->HICUMcqxf) = Qxf_Vxf;
                    ...
                    (!(ckt->CKTmode & MODEUIC)))
                {
                    ...
                    { //Qdeix is now a function of Vxf(t)
            ...
            *(here->HICUMsubsSubsSIPtr) += -Isis_Vsis;
            ...
            if (selfheat)
            {
                ...
                *(here->HICUMsubsSItempPtr) += -Ibpsi_Vrth;
                ...
                rhs_current = Ith - Ith_Vbiei * Vbiei - Ith_Vbici * Vbici - Ith_Vciei * Vciei - Ith_Vbpei * Vbpei - Ith_Vbpci * Vbpci - Ith_Vsici * Vsici - Ith_Vbpbi * Vbpbi - Ith_Vcic * Vcic - Ith_Vbbp * Vbbp - Ith_Veie * Veie - Ith_Vrth * Vrth;
