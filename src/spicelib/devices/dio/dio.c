...
IFparm DIOmPTable[] = { /* model parameters */
 ...
 IOP( "vb",  DIO_MOD_BV,  IF_REAL, "Reverse breakdown voltage"),
 IOP( "vrb",  DIO_MOD_BV,  IF_REAL, "Reverse breakdown voltage"),
 IOP( "var",  DIO_MOD_BV,  IF_REAL, "Reverse breakdown voltage"),
