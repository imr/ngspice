...
IFparm DIOmPTable[] = { /* model parameters */
 ...
 IOP( "vb",  DIO_MOD_BV,  IF_REAL, "Reverse breakdown voltage (level=3)"),
 IOP( "vrb",  DIO_MOD_BV,  IF_REAL, "Reverse breakdown voltage (level=3)"),
 IOP( "var",  DIO_MOD_BV,  IF_REAL, "Reverse breakdown voltage (level=3)"),
