...
#define BSIM3SIMDmodPtr(inst) ((struct sBSIM3model *)((inst)->gen.GENmodPtr))
...
#define BSIM3states gen.GENstate
    ...
    #ifndef OMP_EFFMEM
    /* don't need intermediate NQS variable as those entry
       are already private in the matrix */
    double BSIM3QqPt;
    double BSIM3QdpPt;
    double BSIM3QgPt;
    double BSIM3QspPt;
...
typedef struct sBSIM3group {
	int		InstCount;
	int		EvalCount;
	int		SimdCount;
	BSIM3instance** InstArray; /* actually sub-array of one allocated array globally */
	struct sBSIM3group* next;
} BSIM3group;
...
#define BSIM3SIMDnextModel(inst) ((struct sBSIM3model *)((inst)->gen.GENnextModel))
#define BSIM3SIMDinstances(inst) ((BSIM3instance *)((inst)->gen.GENinstances))
...
extern void BSIM3SIMDevaluate(double,double,double,BSIM3instance*,BSIM3model*,
        double*,double*,double*, double*, double*, double*, double*,
        double*, double*, double*, double*, double*, double*, double*,
        double*, double*, double*, double*, CKTcircuit*);
extern int BSIM3SIMDdebug(BSIM3model*, BSIM3instance*, CKTcircuit*, int);
extern int BSIM3SIMDcheckModel(BSIM3model*, BSIM3instance*, CKTcircuit*);
