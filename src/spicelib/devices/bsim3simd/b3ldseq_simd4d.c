...

{
  ...
  vbs = vec4_SIMDLOADDATA(0, data);
  vgs = vec4_SIMDLOADDATA(1, data);
  vds = vec4_SIMDLOADDATA(2, data);
  qdef = vec4_SIMDLOADDATA(3, data);
  cdhat = vec4_SIMDLOADDATA(4, data);
  cbhat = vec4_SIMDLOADDATA(5, data);
  Check = vec4_SIMDLOADDATA(6, data) > 0.5;
  vbd = vbs - vds;
  vgd = vgs - vds;
  vgb = vgs - vbs;
  ...
  vec4_StateSub(ckt->CKTrhs, (Vec4m ){heres[0]->BSIM3gNode, heres[1]->BSIM3gNode, heres[2]->BSIM3gNode, heres[3]->BSIM3gNode}, m * ceqqg);
  vec4_StateSub(ckt->CKTrhs, (Vec4m ){heres[0]->BSIM3bNode, heres[1]->BSIM3bNode, heres[2]->BSIM3bNode, heres[3]->BSIM3bNode}, m * ((ceqbs + ceqbd) + ceqqb));
  vec4_StateAdd(ckt->CKTrhs, (Vec4m ){heres[0]->BSIM3dNodePrime, heres[1]->BSIM3dNodePrime, heres[2]->BSIM3dNodePrime, heres[3]->BSIM3dNodePrime}, m * ((ceqbd - cdreq) - ceqqd));
  vec4_StateAdd(ckt->CKTrhs, (Vec4m ){heres[0]->BSIM3sNodePrime, heres[1]->BSIM3sNodePrime, heres[2]->BSIM3sNodePrime, heres[3]->BSIM3sNodePrime}, m * ((((cdreq + ceqbs) + ceqqg) + ceqqb) + ceqqd));
  if (heres[0]->BSIM3nqsMod)
