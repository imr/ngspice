...

{
  ...
  vec2_StateSub(ckt->CKTrhs, (Vec2m ){heres[0]->BSIM3gNode, heres[1]->BSIM3gNode}, m * ceqqg);
  vec2_StateSub(ckt->CKTrhs, (Vec2m ){heres[0]->BSIM3bNode, heres[1]->BSIM3bNode}, m * ((ceqbs + ceqbd) + ceqqb));
  vec2_StateAdd(ckt->CKTrhs, (Vec2m ){heres[0]->BSIM3dNodePrime, heres[1]->BSIM3dNodePrime}, m * ((ceqbd - cdreq) - ceqqd));
  vec2_StateAdd(ckt->CKTrhs, (Vec2m ){heres[0]->BSIM3sNodePrime, heres[1]->BSIM3sNodePrime}, m * ((((cdreq + ceqbs) + ceqqg) + ceqqb) + ceqqd));
  if (heres[0]->BSIM3nqsMod)
