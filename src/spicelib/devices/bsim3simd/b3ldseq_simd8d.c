...

{
  ...
  vec8_StateSub(ckt->CKTrhs, (Vec8m ){heres[0]->BSIM3gNode, heres[1]->BSIM3gNode, heres[2]->BSIM3gNode, heres[3]->BSIM3gNode, heres[4]->BSIM3gNode, heres[5]->BSIM3gNode, heres[6]->BSIM3gNode, heres[7]->BSIM3gNode}, m * ceqqg);
  vec8_StateSub(ckt->CKTrhs, (Vec8m ){heres[0]->BSIM3bNode, heres[1]->BSIM3bNode, heres[2]->BSIM3bNode, heres[3]->BSIM3bNode, heres[4]->BSIM3bNode, heres[5]->BSIM3bNode, heres[6]->BSIM3bNode, heres[7]->BSIM3bNode}, m * ((ceqbs + ceqbd) + ceqqb));
  vec8_StateAdd(ckt->CKTrhs, (Vec8m ){heres[0]->BSIM3dNodePrime, heres[1]->BSIM3dNodePrime, heres[2]->BSIM3dNodePrime, heres[3]->BSIM3dNodePrime, heres[4]->BSIM3dNodePrime, heres[5]->BSIM3dNodePrime, heres[6]->BSIM3dNodePrime, heres[7]->BSIM3dNodePrime}, m * ((ceqbd - cdreq) - ceqqd));
  vec8_StateAdd(ckt->CKTrhs, (Vec8m ){heres[0]->BSIM3sNodePrime, heres[1]->BSIM3sNodePrime, heres[2]->BSIM3sNodePrime, heres[3]->BSIM3sNodePrime, heres[4]->BSIM3sNodePrime, heres[5]->BSIM3sNodePrime, heres[6]->BSIM3sNodePrime, heres[7]->BSIM3sNodePrime}, m * ((((cdreq + ceqbs) + ceqqg) + ceqqb) + ceqqd));
  if (heres[0]->BSIM3nqsMod)
  ...
  T1 = qdef * ((Vec8d ){heres[0]->BSIM3gtau, heres[1]->BSIM3gtau, heres[2]->BSIM3gtau, heres[3]->BSIM3gtau, heres[4]->BSIM3gtau, heres[5]->BSIM3gtau, heres[6]->BSIM3gtau, heres[7]->BSIM3gtau});
  {
    ...
    *heres[0]->BSIM3DdPtr += val[0];
    *heres[1]->BSIM3DdPtr += val[1];
    *heres[2]->BSIM3DdPtr += val[2];
    *heres[3]->BSIM3DdPtr += val[3];
    *heres[4]->BSIM3DdPtr += val[4];
    *heres[5]->BSIM3DdPtr += val[5];
    *heres[6]->BSIM3DdPtr += val[6];
    *heres[7]->BSIM3DdPtr += val[7];
  }
  {
    Vec8d val = m * (gcggb - ggtg);
    *heres[0]->BSIM3GgPtr += val[0];
    *heres[1]->BSIM3GgPtr += val[1];
    *heres[2]->BSIM3GgPtr += val[2];
    *heres[3]->BSIM3GgPtr += val[3];
    *heres[4]->BSIM3GgPtr += val[4];
    *heres[5]->BSIM3GgPtr += val[5];
    *heres[6]->BSIM3GgPtr += val[6];
    *heres[7]->BSIM3GgPtr += val[7];
  }
  {
    ...
    *heres[0]->BSIM3SsPtr += val[0];
    *heres[1]->BSIM3SsPtr += val[1];
    *heres[2]->BSIM3SsPtr += val[2];
    *heres[3]->BSIM3SsPtr += val[3];
    *heres[4]->BSIM3SsPtr += val[4];
    *heres[5]->BSIM3SsPtr += val[5];
    *heres[6]->BSIM3SsPtr += val[6];
    *heres[7]->BSIM3SsPtr += val[7];
  }
  {
    ...
    *heres[0]->BSIM3BbPtr += val[0];
    *heres[1]->BSIM3BbPtr += val[1];
    *heres[2]->BSIM3BbPtr += val[2];
    *heres[3]->BSIM3BbPtr += val[3];
    *heres[4]->BSIM3BbPtr += val[4];
    *heres[5]->BSIM3BbPtr += val[5];
    *heres[6]->BSIM3BbPtr += val[6];
    *heres[7]->BSIM3BbPtr += val[7];
  }
  {
    ...
    *heres[0]->BSIM3DPdpPtr += val[0];
    *heres[1]->BSIM3DPdpPtr += val[1];
    *heres[2]->BSIM3DPdpPtr += val[2];
    *heres[3]->BSIM3DPdpPtr += val[3];
    *heres[4]->BSIM3DPdpPtr += val[4];
    *heres[5]->BSIM3DPdpPtr += val[5];
    *heres[6]->BSIM3DPdpPtr += val[6];
    *heres[7]->BSIM3DPdpPtr += val[7];
  }
  {
    ...
    *heres[0]->BSIM3SPspPtr += val[0];
    *heres[1]->BSIM3SPspPtr += val[1];
    *heres[2]->BSIM3SPspPtr += val[2];
    *heres[3]->BSIM3SPspPtr += val[3];
    *heres[4]->BSIM3SPspPtr += val[4];
    *heres[5]->BSIM3SPspPtr += val[5];
    *heres[6]->BSIM3SPspPtr += val[6];
    *heres[7]->BSIM3SPspPtr += val[7];
  }
  {
    Vec8d val = m * ((Vec8d ){heres[0]->BSIM3drainConductance, heres[1]->BSIM3drainConductance, heres[2]->BSIM3drainConductance, heres[3]->BSIM3drainConductance, heres[4]->BSIM3drainConductance, heres[5]->BSIM3drainConductance, heres[6]->BSIM3drainConductance, heres[7]->BSIM3drainConductance});
    *heres[0]->BSIM3DdpPtr -= val[0];
    *heres[1]->BSIM3DdpPtr -= val[1];
    *heres[2]->BSIM3DdpPtr -= val[2];
    *heres[3]->BSIM3DdpPtr -= val[3];
    *heres[4]->BSIM3DdpPtr -= val[4];
    *heres[5]->BSIM3DdpPtr -= val[5];
    *heres[6]->BSIM3DdpPtr -= val[6];
    *heres[7]->BSIM3DdpPtr -= val[7];
  }
  {
    Vec8d val = m * (((gcggb + gcgdb) + gcgsb) + ggtb);
    *heres[0]->BSIM3GbPtr -= val[0];
    *heres[1]->BSIM3GbPtr -= val[1];
    *heres[2]->BSIM3GbPtr -= val[2];
    *heres[3]->BSIM3GbPtr -= val[3];
    *heres[4]->BSIM3GbPtr -= val[4];
    *heres[5]->BSIM3GbPtr -= val[5];
    *heres[6]->BSIM3GbPtr -= val[6];
    *heres[7]->BSIM3GbPtr -= val[7];
  }
  {
    Vec8d val = m * (gcgdb - ggtd);
    *heres[0]->BSIM3GdpPtr += val[0];
    *heres[1]->BSIM3GdpPtr += val[1];
    *heres[2]->BSIM3GdpPtr += val[2];
    *heres[3]->BSIM3GdpPtr += val[3];
    *heres[4]->BSIM3GdpPtr += val[4];
    *heres[5]->BSIM3GdpPtr += val[5];
    *heres[6]->BSIM3GdpPtr += val[6];
    *heres[7]->BSIM3GdpPtr += val[7];
  }
  {
    Vec8d val = m * (gcgsb - ggts);
    *heres[0]->BSIM3GspPtr += val[0];
    *heres[1]->BSIM3GspPtr += val[1];
    *heres[2]->BSIM3GspPtr += val[2];
    *heres[3]->BSIM3GspPtr += val[3];
    *heres[4]->BSIM3GspPtr += val[4];
    *heres[5]->BSIM3GspPtr += val[5];
    *heres[6]->BSIM3GspPtr += val[6];
    *heres[7]->BSIM3GspPtr += val[7];
  }
  {
    Vec8d val = m * ((Vec8d ){heres[0]->BSIM3sourceConductance, heres[1]->BSIM3sourceConductance, heres[2]->BSIM3sourceConductance, heres[3]->BSIM3sourceConductance, heres[4]->BSIM3sourceConductance, heres[5]->BSIM3sourceConductance, heres[6]->BSIM3sourceConductance, heres[7]->BSIM3sourceConductance});
    *heres[0]->BSIM3SspPtr -= val[0];
    *heres[1]->BSIM3SspPtr -= val[1];
    *heres[2]->BSIM3SspPtr -= val[2];
    *heres[3]->BSIM3SspPtr -= val[3];
    *heres[4]->BSIM3SspPtr -= val[4];
    *heres[5]->BSIM3SspPtr -= val[5];
    *heres[6]->BSIM3SspPtr -= val[6];
    *heres[7]->BSIM3SspPtr -= val[7];
  }
  {
    ...
    *heres[0]->BSIM3BgPtr += val[0];
    *heres[1]->BSIM3BgPtr += val[1];
    *heres[2]->BSIM3BgPtr += val[2];
    *heres[3]->BSIM3BgPtr += val[3];
    *heres[4]->BSIM3BgPtr += val[4];
    *heres[5]->BSIM3BgPtr += val[5];
    *heres[6]->BSIM3BgPtr += val[6];
    *heres[7]->BSIM3BgPtr += val[7];
  }
  {
    ...
    *heres[0]->BSIM3BdpPtr += val[0];
    *heres[1]->BSIM3BdpPtr += val[1];
    *heres[2]->BSIM3BdpPtr += val[2];
    *heres[3]->BSIM3BdpPtr += val[3];
    *heres[4]->BSIM3BdpPtr += val[4];
    *heres[5]->BSIM3BdpPtr += val[5];
    *heres[6]->BSIM3BdpPtr += val[6];
    *heres[7]->BSIM3BdpPtr += val[7];
  }
  {
    ...
    *heres[0]->BSIM3BspPtr += val[0];
    *heres[1]->BSIM3BspPtr += val[1];
    *heres[2]->BSIM3BspPtr += val[2];
    *heres[3]->BSIM3BspPtr += val[3];
    *heres[4]->BSIM3BspPtr += val[4];
    *heres[5]->BSIM3BspPtr += val[5];
    *heres[6]->BSIM3BspPtr += val[6];
    *heres[7]->BSIM3BspPtr += val[7];
  }
  {
    Vec8d val = m * ((Vec8d ){heres[0]->BSIM3drainConductance, heres[1]->BSIM3drainConductance, heres[2]->BSIM3drainConductance, heres[3]->BSIM3drainConductance, heres[4]->BSIM3drainConductance, heres[5]->BSIM3drainConductance, heres[6]->BSIM3drainConductance, heres[7]->BSIM3drainConductance});
    *heres[0]->BSIM3DPdPtr -= val[0];
    *heres[1]->BSIM3DPdPtr -= val[1];
    *heres[2]->BSIM3DPdPtr -= val[2];
    *heres[3]->BSIM3DPdPtr -= val[3];
    *heres[4]->BSIM3DPdPtr -= val[4];
    *heres[5]->BSIM3DPdPtr -= val[5];
    *heres[6]->BSIM3DPdPtr -= val[6];
    *heres[7]->BSIM3DPdPtr -= val[7];
  }
  {
    Vec8d val = m * ((((Gm + gcdgb) + (dxpart * ggtg)) + (T1 * ddxpart_dVg)) + gbdpg);
    *heres[0]->BSIM3DPgPtr += val[0];
    *heres[1]->BSIM3DPgPtr += val[1];
    *heres[2]->BSIM3DPgPtr += val[2];
    *heres[3]->BSIM3DPgPtr += val[3];
    *heres[4]->BSIM3DPgPtr += val[4];
    *heres[5]->BSIM3DPgPtr += val[5];
    *heres[6]->BSIM3DPgPtr += val[6];
    *heres[7]->BSIM3DPgPtr += val[7];
  }
  {
    ...
    *heres[0]->BSIM3DPbPtr -= val[0];
    *heres[1]->BSIM3DPbPtr -= val[1];
    *heres[2]->BSIM3DPbPtr -= val[2];
    *heres[3]->BSIM3DPbPtr -= val[3];
    *heres[4]->BSIM3DPbPtr -= val[4];
    *heres[5]->BSIM3DPbPtr -= val[5];
    *heres[6]->BSIM3DPbPtr -= val[6];
    *heres[7]->BSIM3DPbPtr -= val[7];
  }
  {
    ...
    *heres[0]->BSIM3DPspPtr -= val[0];
    *heres[1]->BSIM3DPspPtr -= val[1];
    *heres[2]->BSIM3DPspPtr -= val[2];
    *heres[3]->BSIM3DPspPtr -= val[3];
    *heres[4]->BSIM3DPspPtr -= val[4];
    *heres[5]->BSIM3DPspPtr -= val[5];
    *heres[6]->BSIM3DPspPtr -= val[6];
    *heres[7]->BSIM3DPspPtr -= val[7];
  }
  {
    Vec8d val = m * ((((gcsgb - Gm) + (sxpart * ggtg)) + (T1 * dsxpart_dVg)) + gbspg);
    *heres[0]->BSIM3SPgPtr += val[0];
    *heres[1]->BSIM3SPgPtr += val[1];
    *heres[2]->BSIM3SPgPtr += val[2];
    *heres[3]->BSIM3SPgPtr += val[3];
    *heres[4]->BSIM3SPgPtr += val[4];
    *heres[5]->BSIM3SPgPtr += val[5];
    *heres[6]->BSIM3SPgPtr += val[6];
    *heres[7]->BSIM3SPgPtr += val[7];
  }
  {
    Vec8d val = m * ((Vec8d ){heres[0]->BSIM3sourceConductance, heres[1]->BSIM3sourceConductance, heres[2]->BSIM3sourceConductance, heres[3]->BSIM3sourceConductance, heres[4]->BSIM3sourceConductance, heres[5]->BSIM3sourceConductance, heres[6]->BSIM3sourceConductance, heres[7]->BSIM3sourceConductance});
    *heres[0]->BSIM3SPsPtr -= val[0];
    *heres[1]->BSIM3SPsPtr -= val[1];
    *heres[2]->BSIM3SPsPtr -= val[2];
    *heres[3]->BSIM3SPsPtr -= val[3];
    *heres[4]->BSIM3SPsPtr -= val[4];
    *heres[5]->BSIM3SPsPtr -= val[5];
    *heres[6]->BSIM3SPsPtr -= val[6];
    *heres[7]->BSIM3SPsPtr -= val[7];
  }
  {
    ...
    *heres[0]->BSIM3SPbPtr -= val[0];
    *heres[1]->BSIM3SPbPtr -= val[1];
    *heres[2]->BSIM3SPbPtr -= val[2];
    *heres[3]->BSIM3SPbPtr -= val[3];
    *heres[4]->BSIM3SPbPtr -= val[4];
    *heres[5]->BSIM3SPbPtr -= val[5];
    *heres[6]->BSIM3SPbPtr -= val[6];
    *heres[7]->BSIM3SPbPtr -= val[7];
  }
  {
    ...
    *heres[0]->BSIM3SPdpPtr -= val[0];
    *heres[1]->BSIM3SPdpPtr -= val[1];
    *heres[2]->BSIM3SPdpPtr -= val[2];
    *heres[3]->BSIM3SPdpPtr -= val[3];
    *heres[4]->BSIM3SPdpPtr -= val[4];
    *heres[5]->BSIM3SPdpPtr -= val[5];
    *heres[6]->BSIM3SPdpPtr -= val[6];
    *heres[7]->BSIM3SPdpPtr -= val[7];
  }
  if (heres[0]->BSIM3nqsMod)
  {
    {
