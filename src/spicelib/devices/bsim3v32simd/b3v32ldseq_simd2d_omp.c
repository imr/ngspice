...

{
  ...
  vbs = (Vec2d ){heres[0]->BSIM3v32SIMDvbs, heres[1]->BSIM3v32SIMDvbs};
  vgs = (Vec2d ){heres[0]->BSIM3v32SIMDvgs, heres[1]->BSIM3v32SIMDvgs};
  vds = (Vec2d ){heres[0]->BSIM3v32SIMDvds, heres[1]->BSIM3v32SIMDvds};
  qdef = (Vec2d ){heres[0]->BSIM3v32SIMDqdef, heres[1]->BSIM3v32SIMDqdef};
  cdhat = (Vec2d ){heres[0]->BSIM3v32SIMDcdhat, heres[1]->BSIM3v32SIMDcdhat};
  cbhat = (Vec2d ){heres[0]->BSIM3v32SIMDcbhat, heres[1]->BSIM3v32SIMDcbhat};
  Check = (Vec2m ){heres[0]->BSIM3v32SIMDCheck, heres[1]->BSIM3v32SIMDCheck};
  SIMDIFYCMD(start);
  vbd = vbs - vds;
  vgd = vgs - vds;
  vgb = vgs - vbs;
  ...
  {
    Vec2d nstate_qbs = vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qbs, heres[1]->BSIM3v32qbs});
    Vec2d nstate_qbd = vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qbd, heres[1]->BSIM3v32qbd});
    if (model->BSIM3v32acmMod == 0)
    {
      switch (model->BSIM3v32intVersion)
      {
    ...
    vec2_StateStore(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qbs, heres[1]->BSIM3v32qbs}, nstate_qbs);
    if (1)
    {
    ...
    vec2_StateStore(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qbd, heres[1]->BSIM3v32qbd}, nstate_qbd);
  }
  ...
  vec2_StateStore(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32vbs, heres[1]->BSIM3v32vbs}, vbs);
  vec2_StateStore(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32vbd, heres[1]->BSIM3v32vbd}, vbd);
  vec2_StateStore(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32vgs, heres[1]->BSIM3v32vgs}, vgs);
  vec2_StateStore(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32vds, heres[1]->BSIM3v32vds}, vds);
  vec2_StateStore(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qdef, heres[1]->BSIM3v32qdef}, qdef);
  if (!ChargeComputationNeeded)
    goto line850;
  ...
  vec2_StateStore(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qg, heres[1]->BSIM3v32qg}, qgate);
  vec2_StateStore(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qd, heres[1]->BSIM3v32qd}, qdrn - vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qbd, heres[1]->BSIM3v32qbd}));
  vec2_StateStore(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qb, heres[1]->BSIM3v32qb}, (qbulk + vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qbd, heres[1]->BSIM3v32qbd})) + vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qbs, heres[1]->BSIM3v32qbs}));
  if (heres[0]->BSIM3v32nqsMod)
  {
    vec2_StateStore(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qcdump, heres[1]->BSIM3v32qcdump}, qdef * ScalingFactor);
    vec2_StateStore(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qcheq, heres[1]->BSIM3v32qcheq}, qcheq);
  }
  ...
  {
    vec2_StateStore(ckt->CKTstate1, (Vec2m ){heres[0]->BSIM3v32qb, heres[1]->BSIM3v32qb}, vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qb, heres[1]->BSIM3v32qb}));
    vec2_StateStore(ckt->CKTstate1, (Vec2m ){heres[0]->BSIM3v32qg, heres[1]->BSIM3v32qg}, vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qg, heres[1]->BSIM3v32qg}));
    vec2_StateStore(ckt->CKTstate1, (Vec2m ){heres[0]->BSIM3v32qd, heres[1]->BSIM3v32qd}, vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qd, heres[1]->BSIM3v32qd}));
    if (heres[0]->BSIM3v32nqsMod)
    {
      vec2_StateStore(ckt->CKTstate1, (Vec2m ){heres[0]->BSIM3v32qcheq, heres[1]->BSIM3v32qcheq}, vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qcheq, heres[1]->BSIM3v32qcheq}));
      vec2_StateStore(ckt->CKTstate1, (Vec2m ){heres[0]->BSIM3v32qcdump, heres[1]->BSIM3v32qcdump}, vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32qcdump, heres[1]->BSIM3v32qcdump}));
    }
  ...
  goto line900;
  line860:
  cqgate = vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32cqg, heres[1]->BSIM3v32cqg});

  cqbulk = vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32cqb, heres[1]->BSIM3v32cqb});
  cqdrn = vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32cqd, heres[1]->BSIM3v32cqd});
  ...
  if (heres[0]->BSIM3v32nqsMod)
  {
    ...
    cqdef = vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32cqcdump, heres[1]->BSIM3v32cqcdump}) - (gqdef * qdef);
    cqcheq = (vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32cqcheq, heres[1]->BSIM3v32cqcheq}) - (((gcqgb * vgb) - (gcqdb * vbd)) - (gcqsb * vbs))) + T0;
  }

  if (ckt->CKTmode & MODEINITTRAN)
  {
    vec2_StateStore(ckt->CKTstate1, (Vec2m ){heres[0]->BSIM3v32cqb, heres[1]->BSIM3v32cqb}, vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32cqb, heres[1]->BSIM3v32cqb}));
    vec2_StateStore(ckt->CKTstate1, (Vec2m ){heres[0]->BSIM3v32cqg, heres[1]->BSIM3v32cqg}, vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32cqg, heres[1]->BSIM3v32cqg}));
    vec2_StateStore(ckt->CKTstate1, (Vec2m ){heres[0]->BSIM3v32cqd, heres[1]->BSIM3v32cqd}, vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32cqd, heres[1]->BSIM3v32cqd}));
    if (heres[0]->BSIM3v32nqsMod)
    {
      vec2_StateStore(ckt->CKTstate1, (Vec2m ){heres[0]->BSIM3v32cqcheq, heres[1]->BSIM3v32cqcheq}, vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32cqcheq, heres[1]->BSIM3v32cqcheq}));
      vec2_StateStore(ckt->CKTstate1, (Vec2m ){heres[0]->BSIM3v32cqcdump, heres[1]->BSIM3v32cqcdump}, vec2_StateAccess(ckt->CKTstate0, (Vec2m ){heres[0]->BSIM3v32cqcdump, heres[1]->BSIM3v32cqcdump}));
    }
  ...
  if (heres[0]->BSIM3v32nqsMod)
    vec2_StateAdd(ckt->CKTrhs, (Vec2m ){heres[0]->BSIM3v32qNode, heres[1]->BSIM3v32qNode}, m * (cqcheq - cqdef));
