...
int OsdiNoise(int mode, int operation, GENmodel *inModel, CKTcircuit *ckt,
  ...
  if (descr->num_noise_src < noise_dense_len) {
      ...
      case N_CALC:
        ...
        case N_DENS:
          ...
          *OnDens += totalNoise;
          ...
          double *noise_vals = osdi_noise_data(entry, gen_inst);
          ...
          if (data->delFreq == 0.0) {
            ...
            for (i = 0; i < descr->num_noise_src; i++) {
              ...
              tempInoise = Nintegrate(
                  noise_dens[i] * data->GainSqInv,
        ...
        case INT_NOIZ: /* already calculated, just output */
          if (job->NStpsSm != 0) {
            ...
            data->outpVector[data->outNumber++] =
                nVar(OUTNOIZ, descr->num_noise_src);
            data->outpVector[data->outNumber++] =
                nVar(INNOIZ, descr->num_noise_src);
          } /* if */
          break;
        } /* switch (mode) */
        break;
