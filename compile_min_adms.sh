...
# You may add  --enable-adms to the following command for adding adms generated devices 
  ../configure --with-wingui --enable-adms --enable-xspice --enable-cider --enable-openmp --disable-debug prefix="C:/Spice64" CFLAGS="-m64 -O2" LDFLAGS="-m64 -s"
else
   cd release
  ...
  echo
# You may add  --enable-adms to the following command for adding adms generated devices 
  ../configure --with-wingui --enable-adms --enable-xspice --enable-cider --enable-openmp --disable-debug prefix="C:/Spice" CFLAGS="-m32 -O2" LDFLAGS="-m32 -s"
fi
