...
FILTER="CPU|Dynamic|Note|Circuit|Trying|Reference|Date|Doing|---|v-sweep|time|Error|Warning|Data|Index|trans|acan|Noise|nalysis|Total|memory|Current|Got|Added|BSIM|bsim"
