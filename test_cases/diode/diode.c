              ...
              double *prev_solve, OsdiSimParas *sim_params)
{
  ...
  // resistor
  double irs = vcic / rs_t;
  double g = 1.0 / rs_t;
  double grt = -irs / rs_t * rs_dt;

  // thermal resistance
  double irth = vdtj / rth_t;
  double gt = 1.0 / rth_t - irth / rth_t * rth_dt;
  ...
  double ith = id * vaci + powf(vcic, 2.0) / rs_t;
  double ith_vtj = gdt * vaci - powf(vcic, 2.0) / rs_t / rs_t * rs_dt;
  double ith_vcic = 2.0 * vcic / rs_t;
